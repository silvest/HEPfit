...
//      std::cout << Heff.LowScaleCoeff(22)-(*(allcoeff_smm[NLO_QED22])) / (sw*sw*(myVCKM(2,2).conjugate() * myVCKM(2,1))) << std::endl;
      ...
      gslpp::complex C9_low = (Heff.LowScaleCoeff(00))(8) + as5*(Heff.LowScaleCoeff(10))(8) +
                                as5*as5*(Heff.LowScaleCoeff(20))(8) + k5*(Heff.LowScaleCoeff(01))(8) +
                                as5*k5*(Heff.LowScaleCoeff(11))(8) + as5*as5*k5*(Heff.LowScaleCoeff(21))(8) +
                                k5*k5*(Heff.LowScaleCoeff(02))(8) + as5*k5*k5*(Heff.LowScaleCoeff(12))(8) +
                                as5*as5*k5*k5*(Heff.LowScaleCoeff(22))(8);
      
      gslpp::complex C9_allcoeff = (*(allcoeff[LO]))(8)  +  (*(allcoeff[NLO]))(8) +
                                (*(allcoeff[NNLO]))(8) + (*(allcoeff[LO_QED ]))(8) +
                                (*(allcoeff[NLO_QED11]))(8) + (*(allcoeff[NLO_QED02]))(8) +
                                (*(allcoeff[NLO_QED21]))(8) + (*(allcoeff[NLO_QED12]))(8) +
                                (*(allcoeff[NLO_QED22]))(8);
      ...
      std::cout << "C9_allcoeff: " << C9_allcoeff / ae5 << std::endl;
      ...
      gslpp::complex C10_low = (Heff.LowScaleCoeff(00))(9) + as5*(Heff.LowScaleCoeff(10))(9) +
                                as5*as5*(Heff.LowScaleCoeff(20))(9) + k5*(Heff.LowScaleCoeff(01))(9) +
                                as5*k5*(Heff.LowScaleCoeff(11))(9) + as5*as5*k5*(Heff.LowScaleCoeff(21))(9) +
                                k5*k5*(Heff.LowScaleCoeff(02))(9) + as5*k5*k5*(Heff.LowScaleCoeff(12))(9) +
                                as5*as5*k5*k5*(Heff.LowScaleCoeff(22))(9);
