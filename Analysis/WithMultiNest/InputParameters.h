...
private:
    ...
    std::map<std::string, double> StandardModel()
    {
        ...
        DPars_IN["MKstarP"] = 0.;
	DPars_IN["csi"] = 0.;
	DPars_IN["FBsSqrtBBs1"] = 0.;
	DPars_IN["FBsSqrtBBs2"] = 0.;
	DPars_IN["FBsSqrtBBs3"] = 0.;
	DPars_IN["FBsSqrtBBs4"] = 0.;
	DPars_IN["FBsSqrtBBs5"] = 0.;
	DPars_IN["FBdSqrtBBd2"] = 0.;
	DPars_IN["FBdSqrtBBd3"] = 0.;
	DPars_IN["FBdSqrtBBd4"] = 0.;
	DPars_IN["FBdSqrtBBd5"] = 0.;
	DPars_IN["BBdscale"] = 0.;
	DPars_IN["BBdscheme"] = 0.;
	DPars_IN["absh_0_MP"] = 0.;
  DPars_IN["absh_0_MP"] = 0.;
  /* DPars_IN["absh_p_MP"] = 0.; */
  /* DPars_IN["absh_m_MP"] = 0.; */
  DPars_IN["argh_0_MP"] = 0.;
  /* DPars_IN["argh_p_MP"] = 0.; */
  /* DPars_IN["argh_m_MP"] = 0.; */
  DPars_IN["absh_0_1_MP"] = 0.;
  /* DPars_IN["absh_p_1_MP"] = 0.; */
  /* DPars_IN["absh_m_1_MP"] = 0.; */
  DPars_IN["argh_0_1_MP"] = 0.;
  /* DPars_IN["argh_p_1_MP"] = 0.; */
  /* DPars_IN["argh_m_1_MP"] = 0.; */
  DPars_IN["alpha1kp"] = 0.;
  DPars_IN["alpha2kp"] = 0.;
//DPars_IN["
//"] = 0.;
