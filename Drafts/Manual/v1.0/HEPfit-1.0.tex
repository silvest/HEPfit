...
\author[a]{\hspace*{-8pt}\colorbox{white}{}\hspace*{-4pt}: M.~Ciuchini}
\author[b]{J.~de Blas}
\author[b]{D.~Chowdhury}
\author[b]{O.~Eberhardt}
\author[b]{M.~Fedele}
\author[b]{E.~Franco}
\author[c]{S.~Mishima}
\author[b]{A.~Paul}
\author[d]{M.~Pierini}
\author[e]{L.~Reina}
\author[b]{L.~Silvestrini}
\author[f]{M.~Valli}
\author[g]{N.~Yokozaki}

\address[a]{INFN,  Sezione di Roma Tre, Via della Vasca Navale 84, I-00146 Roma, Italy}
\address[b]{INFN, Sezione di Roma, Piazzale A. Moro 2, I-00185 Roma, Italy}
...
\end{eqnarray}
 ...
 The mass parameters with {\it hats} in the super-CKM basis are related to the original parameters in Eqs. (\ref{eq:soft_trilinear}) and (\ref{eq:sq_softmass}) as
 \begin{eqnarray}
...
Satoshi
\cite{Bardin:1992jc,Bardin:1999yd,Arbuzov:2005ma,Akhundov:2013ons}
