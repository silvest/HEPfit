...
public:
    ...
    virtual double RGERunner(/*int RGEs, const*/ double InitialValues[], unsigned long int NumberOfRGEs, double Q1, double Q2, bool order);
...
//    virtual int RGEs(double t, const double y[], double beta[], void *order);
