...
Hobs_pp_A_HZ_bbll_CMS8::Hobs_pp_A_HZ_bbll_CMS8(const StandardModel& SM_i)
: ThObservable(SM_i),myTHDM(static_cast<const THDM&> (SM_i))
{}

double Hobs_pp_A_HZ_bbll_CMS8::computeThValue()
{
    return myTHDM.getMyTHDMCache()->THoEX_pp_A_HZ_bbll_CMS8;
}

Robs_pp_A_HZ_bbll_CMS8::Robs_pp_A_HZ_bbll_CMS8(const StandardModel& SM_i)
: ThObservable(SM_i),myTHDM(static_cast<const THDM&> (SM_i))
{}

double Robs_pp_A_HZ_bbll_CMS8::computeThValue()
{
    return myTHDM.getMyTHDMCache()->R_pp_A_HZ_bbll_CMS8;
}



Hobs_pp_A_HZ_tautaull_CMS8::Hobs_pp_A_HZ_tautaull_CMS8(const StandardModel& SM_i)
: ThObservable(SM_i),myTHDM(static_cast<const THDM&> (SM_i))
{}

double Hobs_pp_A_HZ_tautaull_CMS8::computeThValue()
{
    return myTHDM.getMyTHDMCache()->THoEX_pp_A_HZ_tautaull_CMS8;
}

Robs_pp_A_HZ_tautaull_CMS8::Robs_pp_A_HZ_tautaull_CMS8(const StandardModel& SM_i)
: ThObservable(SM_i),myTHDM(static_cast<const THDM&> (SM_i))
{}

double Robs_pp_A_HZ_tautaull_CMS8::computeThValue()
{
    return myTHDM.getMyTHDMCache()->R_pp_A_HZ_tautaull_CMS8;
}
...
Hobs_ggF_A_Zga_llga_ATLAS13::Hobs_ggF_A_Zga_llga_ATLAS13(const StandardModel& SM_i)
: ThObservable(SM_i),myTHDM(static_cast<const THDM&> (SM_i))
{}

double Hobs_ggF_A_Zga_llga_ATLAS13::computeThValue()
{
    return myTHDM.getMyTHDMCache()->THoEX_ggF_A_Zga_llga_ATLAS13;
}

Robs_ggF_A_Zga_llga_ATLAS13::Robs_ggF_A_Zga_llga_ATLAS13(const StandardModel& SM_i)
: ThObservable(SM_i),myTHDM(static_cast<const THDM&> (SM_i))
{}

double Robs_ggF_A_Zga_llga_ATLAS13::computeThValue()
{
    return myTHDM.getMyTHDMCache()->R_ggF_A_Zga_llga_ATLAS13;
}
...
Hobs_ggF_A_Zga_CMS13::Hobs_ggF_A_Zga_CMS13(const StandardModel& SM_i)
: ThObservable(SM_i),myTHDM(static_cast<const THDM&> (SM_i))
{}

double Hobs_ggF_A_Zga_CMS13::computeThValue()
{
    return myTHDM.getMyTHDMCache()->THoEX_ggF_A_Zga_CMS13;
}

Robs_ggF_A_Zga_CMS13::Robs_ggF_A_Zga_CMS13(const StandardModel& SM_i)
: ThObservable(SM_i),myTHDM(static_cast<const THDM&> (SM_i))
{}

double Robs_ggF_A_Zga_CMS13::computeThValue()
{
    return myTHDM.getMyTHDMCache()->R_ggF_A_Zga_CMS13;
}
...
log10_pp_A_HZ_bbll_TH8::log10_pp_A_HZ_bbll_TH8(const StandardModel& SM_i)
: ThObservable(SM_i),myTHDM(static_cast<const THDM&> (SM_i))
{}

double log10_pp_A_HZ_bbll_TH8::computeThValue()
{
    return log10(myTHDM.getMyTHDMCache()->pp_A_HZ_bbll_TH8);
}



log10_pp_A_HZ_tautaull_TH8::log10_pp_A_HZ_tautaull_TH8(const StandardModel& SM_i)
: ThObservable(SM_i),myTHDM(static_cast<const THDM&> (SM_i))
{}

double log10_pp_A_HZ_tautaull_TH8::computeThValue()
{
    return log10(myTHDM.getMyTHDMCache()->pp_A_HZ_tautaull_TH8);
}
...
log10_ggF_A_Zga_TH13::log10_ggF_A_Zga_TH13(const StandardModel& SM_i)
: ThObservable(SM_i),myTHDM(static_cast<const THDM&> (SM_i))
{}

double log10_ggF_A_Zga_TH13::computeThValue()
{
    return log10(myTHDM.getMyTHDMCache()->ggF_A_Zga_TH13);
}
