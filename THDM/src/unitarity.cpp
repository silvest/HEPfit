...
double unitarityRp21::computeThValue()
{
    ...
    {
        Rp = (uniNLO25b+uniNLO25c+uniNLO25d).abs()/fabs(uniNLO25a);
    }
...
double unitarityRp22::computeThValue()
{
    ...
    {
        Rp = (uniNLO26b+uniNLO26c+uniNLO26d).abs()/fabs(uniNLO26a);
    }
...
unitarityR21::unitarityR21(const StandardModel& SM_i)
: ThObservable(SM_i),myTHDM(static_cast<const THDM&> (SM_i))
{}

double unitarityR21::computeThValue()
{
    double YtQ = myTHDM.getMyTHDMCache()->Ytop_at_Q;
    double Yb1Q = myTHDM.getMyTHDMCache()->Ybottom1_at_Q;
    double Yb2Q = myTHDM.getMyTHDMCache()->Ybottom2_at_Q;
    ...
    double R=0.01;
    gslpp::complex a0NLO = uniNLO25a+uniNLO25b+uniNLO25c+uniNLO25d;
    if(a0NLO.abs()>Rpeps)
    {
        R = (a0NLO-uniNLO25a).abs()/(a0NLO.abs());
    }

    return R;
}

unitarityR22::unitarityR22(const StandardModel& SM_i)
: ThObservable(SM_i),myTHDM(static_cast<const THDM&> (SM_i))
{}

double unitarityR22::computeThValue()
{
    double YtQ = myTHDM.getMyTHDMCache()->Ytop_at_Q;
    double Yb1Q = myTHDM.getMyTHDMCache()->Ybottom1_at_Q;
    double Yb2Q = myTHDM.getMyTHDMCache()->Ybottom2_at_Q;
    ...
    double R=0.01;
    gslpp::complex a0NLO = uniNLO26a+uniNLO26b+uniNLO26c+uniNLO26d;
    if(a0NLO.abs()>Rpeps)
    {
        R = (a0NLO-uniNLO26a).abs()/(a0NLO.abs());
    }
