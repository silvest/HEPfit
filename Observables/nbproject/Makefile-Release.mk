...
${OBJECTDIR}/src/Observable2D.o: src/Observable2D.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Observable2D.o src/Observable2D.cpp
...
${OBJECTDIR}/src/ThObservable.o: src/ThObservable.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ThObservable.o src/ThObservable.cpp
