...
gslpp::vector<gslpp::complex>** HeffDLij::ComputeCoeffDLij(int li_lj) {
    ...
    switch (li_lj) {
        case 1:
        {
            const std::vector<WilsonCoefficient>& mcb1 = model.getMatching().CMDLij(1);
        ...
        case 2:
        {
            const std::vector<WilsonCoefficient>& mcb2 = model.getMatching().CMDLij(2);
        ...
        case 3:
        {
            const std::vector<WilsonCoefficient>& mcb3 = model.getMatching().CMDLij(3);
