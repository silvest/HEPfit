...
gslpp::vector<gslpp::complex>** HeffDLi3j::ComputeCoeffDLi3j(int li_lj) {
    ...
    switch (li_lj) {
        case 1:
        {
            const std::vector<WilsonCoefficient>& mcb4 = model.getMatching().CMDLi3j(1);
        ...
        case 2:
        {
            const std::vector<WilsonCoefficient>& mcb5 = model.getMatching().CMDLi3j(2);
        ...
        case 3:
        {
            const std::vector<WilsonCoefficient>& mcb6 = model.getMatching().CMDLi3j(3);
        ...
        case 4:
        {
            const std::vector<WilsonCoefficient>& mcb7 = model.getMatching().CMDLi3j(4);
