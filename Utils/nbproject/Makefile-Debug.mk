...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/libutils.a
...
${OBJECTDIR}/src/Parameters.o: src/Parameters.cc 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I../gslpp/src -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Parameters.o src/Parameters.cc
...
${TESTDIR}/tests/UtilsTest.o: tests/UtilsTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I../gslpp/src -MMD -MP -MF $@.d -o ${TESTDIR}/tests/UtilsTest.o tests/UtilsTest.cpp
...
${OBJECTDIR}/src/Parameters_nomain.o: ${OBJECTDIR}/src/Parameters.o src/Parameters.cc 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I../gslpp/src -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Parameters_nomain.o src/Parameters.cc;\
	else  \
