...
/////////////////////////////////////////////////////////////////////////////////////////////
//LEP2 observables and related functions migrated from EW/LEP2TwoFermions.cpp


double EWSMTwoFermionsLEP2::dsigma_l(const QCD::lepton l, const double mf, 
...
double EWSMTwoFermionsLEP2::dsigma_q(const QCD::quark q, const double mf, 
                                 const double s, const double cosTheta,
                                 const double Mw, const double GammaZ, 
                                 const bool bWeak) const 
{
...
double EWSMTwoFermionsLEP2::dsigma_l_box(const QCD::lepton l, const double mf, 
                                     const double s, const double cosTheta,
...
double EWSMTwoFermionsLEP2::dsigma_q_box(const QCD::quark q, const double mf,
                                     const double s, const double cosTheta,
                                     const double Mw, const double GammaZ) const 
{
    double I3f = cache.getSM().getQuarks(q).getIsospin();
...
double EWSMTwoFermionsLEP2::sigma_l(const QCD::lepton l, const double mf, 
...
double EWSMTwoFermionsLEP2::sigma_q(const QCD::quark q, const double mf, 
                                const double s, const double Mw, 
                                const double GammaZ, const bool bWeak) const 
{
    double I3f = cache.getSM().getQuarks(q).getIsospin();
...
double EWSMTwoFermionsLEP2::AFB_l(const QCD::lepton l, const double mf, 
                              const double s, const double Mw, 
                              const double GammaZ, const bool bWeak) const 
{
    double I3f = cache.getSM().getLeptons(l).getIsospin();
...
double EWSMTwoFermionsLEP2::AFB_q(const QCD::quark q, const double mf, 
                              const double s, const double Mw, 
                              const double GammaZ, const bool bWeak) const 
{
    double I3f = cache.getSM().getQuarks(q).getIsospin();
...
double EWSMTwoFermionsLEP2::QED_FSR_forSigma(const double s, const double Qf) const
{
...
double EWSMTwoFermionsLEP2::H_ISR(const double x, const double s) const 
{
...
double EWSMTwoFermionsLEP2::H_ISR_FB(const double x, const double s) const 
{
    double me = cache.getSM().getLeptons(cache.getSM().ELECTRON).getMass();
    double alphaOverPi = cache.getSM().getAle()/M_PI; // alpha(0)/Pi
    double L = log(s/(me*me));
...
double EWSMTwoFermionsLEP2::dsigma(const double s, const double cosTheta, 
                               const double Mw, const double GammaZ, 
                               const double I3f, const double Qf, 
                               const double mf, const double mfp, 
...
double EWSMTwoFermionsLEP2::dsigma_box(const double s, const double cosTheta, 
                                   const double Mw, const double GammaZ, 
                                   const double I3f, const double Qf, 
                                   const double mf, const double mfp, 
