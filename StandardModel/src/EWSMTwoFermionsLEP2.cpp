    ...
    if (bWeak)
        rhoef += SM.getAle()/4.0/M_PI/sW2
                 *( - DeltaRhobarZ(mu, Mw) + D_Z_hat(s, Mw) 
                    + 5.0/3.0*PV.B0(mu*mu, s, Mw2, Mw2, true) - 9.0*cW2/4.0/sW2*log(cW2)
    ...
    if (bWeak)
        kappae += SM.getAle()/4.0/M_PI/sW2    
                  *( - cW2/sW2*DeltaRhobar(mu, Mw) + Pibar_Zgamma_hat(s, Mw)
                     - PV.B0(mu*mu, s, Mw2, Mw2, true)/6.0 - 1.0/9.0
    ...
    if (bWeak)
        kappaef += SM.getAle()/4.0/M_PI/sW2    
                   *( - 2.0*cW2/sW2*DeltaRhobar(mu, Mw) + 2.0*Pibar_Zgamma_hat(s, Mw)
                      - PV.B0(mu*mu, s, Mw2, Mw2, true)/3.0 - 2.0/9.0
                                              ...
                                              const bool bWWbox) const 
{
    ...
    return ( SM.getAle()/4.0/M_PI/sW2
             *( F_W_t_hat(s, Mw) 
                - Mt*Mt/4.0/Mw/Mw*(PV.B0(mu*mu, s, Mw2, Mw2, true) + 1.0) ) + Bww );
}
                                      ...
                                      const double Mw) const 
{
    ...
    return ( ( - t*(1.0 + t2/u2) - 4.0*Mw2*t2/u2 + 2.0*Mw2*Mw2/u*(1.0 + 2.0*s/u) )
              *PV.D0(s, t, Mw2, 0.0, Mw2, 0.0, true)
             - 2.0*( 2.0 + 2.0*s/u + s2/u2 - 2.0*Mw2*s/u2 )*PV.C0(s, Mw2, 0.0, Mw2, true)
             + 2.0*( 2.0 + 3.0*s/u + s2/u2 + 2.0*Mw2*t/u2 )*PV.C0(t, 0.0, Mw2, 0.0, true)
             + ( - 2.0/u - 5.0/3.0/Mw2 - s/12.0/Mw2/Mw2 )*PV.B0(mu*mu, s, Mw2, Mw2, true)
             + 2.0/u*PV.B0(mu*mu, t, 0.0, 0.0, true) - 1.0/6.0/Mw2/Mw2*PV.A0(mu*mu, Mw2, true)
                                    ...
                                    const double Mw) const 
{
    ...
    return ( ( - t*(1.0 + t2/u2) - 4.0*Mw2*t2/u2 + 2.0*Mw2*Mw2/u*(1.0 + 2.0*s/u) 
               ...
               + Mt2*Mt2*s/u2 )*PV.D0(s, t, Mw2, 0.0, Mw2, Mt2, true)
             + ( - 2.0 - 2.0*s/u - s2/u2 + 2.0*Mw2*s/u2 
                 + Mt2/2.0/Mw2*(4.0 - Mw2/s*(1.0 + 2.0*s2/u2)) 
                 - Mt2*Mt2/2.0/Mw2/Mw2*(1.0 - 2.0*Mw2/s) 
                 - Mt2*Mt2*Mt2/2.0/Mw2/Mw2/s )*PV.C0(s, Mw2, Mt2, Mw2, true)
             - ( 2.0 + 2.0*s/u + s2/u2 - 2.0*Mw2*s/u2 + Mt2*s/u2)*PV.C0(s, Mw2, 0.0, Mw2, true)
             + ( 2.0 + 3.0*s/u + s2/u2 + 2.0*Mw2*t/u2 - Mt2*t/u2)
               *(PV.C0(t, 0.0, Mw2, Mt2, true) + PV.C0(t, Mt2, Mw2, 0.0, true))
             + ( - 2.0/u - 5.0/3.0/Mw2 - s/12.0/Mw2/Mw2 
                 - Mt2/4.0/Mw2/s*(2.0 - s/Mw2) + Mt2*Mt2/2.0/Mw2/Mw2/s )        
               *PV.B0(mu*mu, s, Mw2, Mw2, true)
             + 2.0/u*PV.B0(mu*mu, t, Mt2, 0.0, true) + Mt2/2.0/Mw2/Mw2/s*PV.A0(mu*mu, Mt2, true)
             - 1.0/6.0/Mw2/Mw2*(1.0 + 3.0*Mt2/s)*PV.A0(mu*mu, Mw2, true)
...
{
    double Mw2 = Mw*Mw;
    return ( 2.0*u*PV.D0(s, u, Mw2, 0.0, Mw2, 0.0, true)
             + 4.0*PV.C0(s, Mw2, 0.0, Mw2, true)
             + (20.0 + s/Mw2)/12.0/Mw2*PV.B0(mu*mu, s, Mw2, Mw2, true)
             + PV.A0(mu*mu, Mw2, true)/6.0/Mw2/Mw2 - (1.0 - s/6.0/Mw2)/3.0/Mw2 );
}
                                    ...
                                    const double t, const double u) const 
{
    ...
    return ( 2.0*u*PV.D0(s, u, Mz2, 0.0, Mz2, 0.0, true)
             + ( - 2.0*u - t*(3.0 + t/u)*(3.0 + t/u) 
                 + 2.0*(Mz2 - s)*(1.0 + 3.0*t/u - Mz2/u*(1.0 + 2.0*t/u)) )
               *PV.D0(s, t, Mz2, 0.0, Mz2, 0.0, true)
             + 2.0*( 3.0 + 4.0*t/u + t2/u2 - 2.0*s*(s - Mz2)/u2 )
               *PV.C0(s, Mz2, 0.0, Mz2, true)
             - 2.0*t/u*( 3.0 + t/u + 2.0*(s - Mz2)/u )*PV.C0(t, 0.0, Mz2, 0.0, true)
             - 2.0/u*( PV.B0(mu*mu, s, Mz2, Mz2, true) - PV.B0(mu*mu, t, 0.0, 0.0, true) ) );
}
...
complex EWSMTwoFermionsLEP2::Pibar_Zgamma_hat(const double s, const double Mw) const 
{
    ...
    if (!bKeepNonUnitary) {
        double Mz = SM.getMz(), cW2 = Mw*Mw/(Mz*Mz);
        double Rw = Mw*Mw/s;
        add = - cW2*( (4.0/3.0/Rw + 1.0/12.0/Rw/Rw)*PV.B0(mu*mu,s,Mw*Mw,Mw*Mw, true)
...
complex EWSMTwoFermionsLEP2::Pibar_gg_bos_hat(const double s, const double Mw) const 
{
    ...
    if (!bKeepNonUnitary) {
        ...
        double Rw = Mw*Mw/s;
        add = s/(s - Mz*Mz)
                *( 1.0/12.0/Rw/cW2*PV.B0(mu*mu,s,Mw*Mw,Mw*Mw,true) + 1.0/18.0/Rw/cW2 )
              - s/(s - Mz*Mz)
                *( (4.0/3.0/Rw + 1.0/12.0/Rw/Rw)*PV.B0(mu*mu,s,Mw*Mw,Mw*Mw,true)
                   + 1.0/18.0/Rw/Rw - 13.0/18.0/Rw );
    }
...
complex EWSMTwoFermionsLEP2::D_Z_hat(const double s, const double Mw) const 
{
    ...
    if (!bKeepNonUnitary) {
        double Mz = SM.getMz(), cW2 = Mw*Mw/(Mz*Mz);
        double Rz = Mz*Mz/s;
        add = ( (1.0/12.0/cW2 + 4.0/3.0)/Rz + 1.0/12.0/cW2/Rz/Rz )*PV.B0(mu*mu,s,Mw*Mw,Mw*Mw,true)
...
complex EWSMTwoFermionsLEP2::F_Wn_0_hat(const double s, const double Mw) const 
{
    ...
    if (!bKeepNonUnitary) {
        ...
        add = - s/(s-Mz*Mz)*( - 1.0/12.0/Rw/cW2 + 3.0/2.0/Rw + 1.0/12.0/Rw/Rw )
                *PV.B0(mu*mu,s,Mw*Mw,Mw*Mw,true)
...
complex EWSMTwoFermionsLEP2::F_Wn_t_hat(const double s, const double Mw) const 
{
    ...
    if (!bKeepNonUnitary) {
        ...
        double mu = Mw;
        add = Mt*Mt*s/4.0/Rw/Mw/Mw/(s-Mz*Mz)*(PV.B0(mu*mu,s,Mw*Mw,Mw*Mw,true) + 1.0);
    }
...
complex EWSMTwoFermionsLEP2::F_W_0_hat(const double s, const double Mw) const 
{
    ...
    if (!bKeepNonUnitary) {
        double Rw = Mw*Mw/s;
        double mu = Mw;
        add = cW2*( - 3.0/2.0/Rw - 1.0/12.0/Rw/Rw )*PV.B0(mu*mu,s,Mw*Mw,Mw*Mw,true)
...
complex EWSMTwoFermionsLEP2::F_W_t_hat(const double s, const double Mw) const 
{
    ...
    if (!bKeepNonUnitary) {
        ...
        double Rw = Mw*Mw/s;
        double mu = Mw;
        add = Mt*Mt/4.0/Rw/Mz/Mz*(PV.B0(mu*mu,s,Mw*Mw,Mw*Mw,true) + 1.0);
    }
                                          ...
                                          const double u, const double Mw) const 
{
    ...
    if (!bKeepNonUnitary) {
        ...
        add = (5.0/3.0 - 1.0/12.0/cW2 + 1.0/12.0/Rw)/Rw/(s - Mz*Mz)*PV.B0(mu*mu,s,Mw*Mw,Mw*Mw,true)
                                               ...
                                               const double u, const double Mw) const 
{
    ...
    if (!bKeepNonUnitary) {
        ...
        return ( ( - t*(1.0 + t2/u2) - 4.0*Mw2*t2/u2 + 2.0*Mw2*Mw2/u*(1.0 + 2.0*s/u) )
                 ...
                 - 2.0*( 2.0 + 2.0*s/u + s2/u2 - 2.0*Mw2*s/u2 )*PV.C0(s, Mw2, 0.0, Mw2, true)
                 + 2.0*( 2.0 + 3.0*s/u + s2/u2 + 2.0*Mw2*t/u2 )*PV.C0(t, 0.0, Mw2, 0.0, true)
                 - 2.0/u*( PV.B0(mu*mu, s, Mw2, Mw2,true) - PV.B0(mu*mu, t, 0.0, 0.0, true) ) );
    } else {
                                              ...
                                              const double u, const double Mw) const 
{
    ...
    if (!bKeepNonUnitary) {
        double Mz = SM.getMz(), Rw = Mw*Mw/s, Mt = SM.getMtpole();
        add = - Mt*Mt/4.0/Rw/Mw/Mw/(s - Mz*Mz)*( PV.B0(mu*mu, s, Mw*Mw, Mw*Mw,true) + 1.0 );
    }
