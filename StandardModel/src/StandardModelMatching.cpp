...
double StandardModelMatching::X1t(double x) const{
    ...
    return (-(29. * x - x2 -4. * x3) / (3. * (1. - x) * (1. - x))
            ...
            - 8. * x * log(Mut*Mut/Mw/Mw) * (8. - 9. * x + x3 + 6. * logx)/8./xm3 );
  }
...
double StandardModelMatching::phi1(double z) const{
    if (z >= 0.) {
        if (z < 1){
            ...
            return((1. / sqrt(1. - 1. / z)) * (2. * log(0.5 * ( 1. - sqrt(1. - 1. / z) )) * log(0.5 * ( 1. - sqrt(1. - 1. / z) ))- 4. * gslpp_special_functions::dilog(0.5 * ( 1. - sqrt(1. - 1. / z) )) - log(4. * z) * log(4. * z)
                    + M_PI * M_PI / 3.));
        }
    }
    else{
...
double StandardModelMatching::phi2(double x, double y) const{
    ...
    else if(l2 < 0. and (sqrt(x) + sqrt(y)) > 1.){
        return(2./sqrt( -l2) * (gslpp_special_functions::clausen(2. * acos((-1. + x + y)/(2. * sqrt(x * y))))
