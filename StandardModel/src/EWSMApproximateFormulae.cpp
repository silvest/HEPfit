...
double EWSMApproximateFormulae::DeltaR_TwoLoopEW(const double DeltaAlpha_i) const {
    throw "Write codes!!";
}


double EWSMApproximateFormulae::DeltaKappa_l_TwoLoopEW(const double DeltaAlpha_i) const {
    throw "Write codes!!";    
}


double EWSMApproximateFormulae::DeltaKappa_b_TwoLoopEW(const double DeltaAlpha_i) const {
    throw "Write codes!!";
}
