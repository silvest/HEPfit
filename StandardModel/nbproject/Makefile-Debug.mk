...
${OBJECTDIR}/StandardModel.o: StandardModel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../gslpp -MMD -MP -MF $@.d -o ${OBJECTDIR}/StandardModel.o StandardModel.cpp
...
${TESTDIR}/tests/StandardModelTest.o: tests/StandardModelTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I../gslpp -MMD -MP -MF $@.d -o ${TESTDIR}/tests/StandardModelTest.o tests/StandardModelTest.cpp
...
${OBJECTDIR}/StandardModel_nomain.o: ${OBJECTDIR}/StandardModel.o StandardModel.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I../gslpp -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/StandardModel_nomain.o StandardModel.cpp;\
	else  \
