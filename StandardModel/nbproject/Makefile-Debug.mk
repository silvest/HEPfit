...
${OBJECTDIR}/src/NewPhysicsSTU.o: src/NewPhysicsSTU.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -I/usr/include/root -I../gslpp/src -I../Utils/src -I../LoopFunctions/src -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/NewPhysicsSTU.o src/NewPhysicsSTU.cpp
...
${OBJECTDIR}/src/NewPhysicsSTU_nomain.o: ${OBJECTDIR}/src/NewPhysicsSTU.o src/NewPhysicsSTU.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Wall -I/usr/include/root -I../gslpp/src -I../Utils/src -I../LoopFunctions/src -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/NewPhysicsSTU_nomain.o src/NewPhysicsSTU.cpp;\
	else  \
