...
${TESTDIR}/tests/LF_CppUnitTestClass.o: tests/LF_CppUnitTestClass.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/LF_CppUnitTestClass.o tests/LF_CppUnitTestClass.cpp


${TESTDIR}/tests/LF_CppUnitTestRunner.o: tests/LF_CppUnitTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/LF_CppUnitTestRunner.o tests/LF_CppUnitTestRunner.cpp


${TESTDIR}/tests/LoopFunctionsTest.o: tests/LoopFunctionsTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/LoopFunctionsTest.o tests/LoopFunctionsTest.cpp
