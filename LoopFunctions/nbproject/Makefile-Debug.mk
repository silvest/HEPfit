...
${OBJECTDIR}/src/Polylogarithms.o: src/Polylogarithms.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I../gslpp/src -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Polylogarithms.o src/Polylogarithms.cpp
...
${TESTDIR}/tests/LFtestclass.o: tests/LFtestclass.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I. -Isrc -I../gslpp/src -MMD -MP -MF $@.d -o ${TESTDIR}/tests/LFtestclass.o tests/LFtestclass.cpp


${TESTDIR}/tests/LFtestrunner.o: tests/LFtestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -I. -Isrc -I../gslpp/src -MMD -MP -MF $@.d -o ${TESTDIR}/tests/LFtestrunner.o tests/LFtestrunner.cpp


${TESTDIR}/tests/LoopFunctionsTest.o: tests/LoopFunctionsTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. -Isrc -I../gslpp/src -MMD -MP -MF $@.d -o ${TESTDIR}/tests/LoopFunctionsTest.o tests/LoopFunctionsTest.cpp
...
${OBJECTDIR}/src/Polylogarithms_nomain.o: ${OBJECTDIR}/src/Polylogarithms.o src/Polylogarithms.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I../gslpp/src -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Polylogarithms_nomain.o src/Polylogarithms.cpp;\
	else  \
