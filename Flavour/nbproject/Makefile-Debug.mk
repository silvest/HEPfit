...
${OBJECTDIR}/src/Vcb.o: src/Vcb.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I../Observables/src -I../StandardModel/src -I../gslpp/src -I../Utils/src -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Vcb.o src/Vcb.cpp

${OBJECTDIR}/src/gamma.o: src/gamma.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -I../Observables/src -I../StandardModel/src -I../gslpp/src -I../Utils/src -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/gamma.o src/gamma.cpp

${OBJECTDIR}/src/Vus.o: src/Vus.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -I../Observables/src -I../StandardModel/src -I../gslpp/src -I../Utils/src -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Vus.o src/Vus.cpp
...
${OBJECTDIR}/src/alpha.o: src/alpha.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -I../Observables/src -I../StandardModel/src -I../gslpp/src -I../Utils/src -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/alpha.o src/alpha.cpp

${OBJECTDIR}/src/Vud.o: src/Vud.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -I../Observables/src -I../StandardModel/src -I../gslpp/src -I../Utils/src -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Vud.o src/Vud.cpp

${OBJECTDIR}/src/Flavour.o: src/Flavour.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -I../Observables/src -I../StandardModel/src -I../gslpp/src -I../Utils/src -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Flavour.o src/Flavour.cpp

${OBJECTDIR}/src/Dmb.o: src/Dmb.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -I../Observables/src -I../StandardModel/src -I../gslpp/src -I../Utils/src -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Dmb.o src/Dmb.cpp
