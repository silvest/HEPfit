...
std::vector<std::string> MVll::initializeMVllParameters()
{
    ...
    if (vectorM == StandardModel::PHI) 
        if (MVll_DM_flag) mvllParameters = make_vector<std::string>()
            << "a_0fphi" << "a_1fphi" << "a_2fphi" << "a_0gphi" << "a_1gphi" << "a_2gphi"
            << "a_1F1phi" << "a_2F1phi" << "a_1F2phi" << "a_2F2phi" /*a_0F1 and a_0F2 are not independent*/
            << "a_0T1phi" << "a_1T1phi" << "a_2T1phi" << "a_1T2phi" << "a_2T2phi"
            << "a_1T0phi" << "a_2T0phi" /*a_0T0 and a_0T2 are not independent*/
            << "mBs_1" << "mBs_2" << "mBsst_1" << "mBsst_2" << "mBs1_1" << "mBs1_2"
        ...
        if (MVll_DM_flag) mvllParameters = make_vector<std::string>()
            << "a_0f" << "a_1f" << "a_2f" << "a_0g" << "a_1g" << "a_2g"
            << "a_1F1" << "a_2F1" << "a_1F2" << "a_2F2" /*a_0F1 and a_0F2 are not independent*/
            << "a_0T1" << "a_1T1" << "a_2T1" << "a_1T2" << "a_2T2"
            << "a_1T0" << "a_2T0" /*a_0T0 and a_0T2 are not independent*/
            << "mBs_1" << "mBs_2" << "mBsst_1" << "mBsst_2" << "mBs1_1" << "mBs1_2"
            << "Chi1minus" << "Chi1plus" << "Chi0plus" << "Chi0minus" << "ChiTT" << "ChiBB"
            << "absh_0" << "absh_p" << "absh_m" << "argh_0" << "argh_p" << "argh_m"
            << "absh_0_1" << "absh_p_1" << "absh_m_1" << "argh_0_1" << "argh_p_1" << "argh_m_1"
    ...
    switch (vectorM) {
        ...
        case StandardModel::K_star_P:
            if (MVll_DM_flag) {
                ...
                MRf_2 = mySM.getOptionalParameter("mBs1_1") * mySM.getOptionalParameter("mBs1_1");
                MRf2_2 = mySM.getOptionalParameter("mBs1_2") * mySM.getOptionalParameter("mBs1_2");

                a_0g = mySM.getOptionalParameter("a_0g");
                a_1g = mySM.getOptionalParameter("a_1g");
                a_2g = mySM.getOptionalParameter("a_2g");
                MRg_2 = mySM.getOptionalParameter("mBsst_1") * mySM.getOptionalParameter("mBsst_1");
                MRg2_2 = mySM.getOptionalParameter("mBsst_2") * mySM.getOptionalParameter("mBsst_2");

                a_1F1 = mySM.getOptionalParameter("a_1F1");
                a_2F1 = mySM.getOptionalParameter("a_2F1");
                MRF1_2 = mySM.getOptionalParameter("mBs1_1") * mySM.getOptionalParameter("mBs1_1");
                MRF12_2 = mySM.getOptionalParameter("mBs1_2") * mySM.getOptionalParameter("mBs1_2");
                a_0F1 = f_DM(t_m,a_0f,a_1f,a_2f,MRf_2,MRf2_2)*MM*(1. - rV)*phi_F1(t_m, MRF1_2, MRF12_2) - a_1F1*z_DM(t_m) - a_2F1*z_DM(t_m)*z_DM(t_m);

                a_1F2 = mySM.getOptionalParameter("a_1F2");
                a_2F2 = mySM.getOptionalParameter("a_2F2");
                MRF2_2 = mySM.getOptionalParameter("mBs_1") * mySM.getOptionalParameter("mBs_1");
                MRF22_2 = mySM.getOptionalParameter("mBs_2") * mySM.getOptionalParameter("mBs_2");
                a_0F2 = F1_DM(0.,a_0F1,a_1F1,a_2F1,MRF1_2,MRF12_2)*2./MM2/(1. - rV*rV)*phi_F2(0., MRF2_2, MRF22_2) - a_1F2*z_DM(0.) - a_2F2*z_DM(0.)*z_DM(0.);

                a_0T1 = mySM.getOptionalParameter("a_0T1");
                a_1T1 = mySM.getOptionalParameter("a_1T1");
                a_2T1 = mySM.getOptionalParameter("a_2T1");
                MRT1_2 = mySM.getOptionalParameter("mBsst_1") * mySM.getOptionalParameter("mBsst_1");
                MRT12_2 = mySM.getOptionalParameter("mBsst_2") * mySM.getOptionalParameter("mBsst_2");

                a_1T2 = mySM.getOptionalParameter("a_1T2");
                a_2T2 = mySM.getOptionalParameter("a_2T2");
                MRT2_2 = mySM.getOptionalParameter("mBs1_1") * mySM.getOptionalParameter("mBs1_1");
                MRT22_2 = mySM.getOptionalParameter("mBs1_2") * mySM.getOptionalParameter("mBs1_2");
                a_0T2 = T1_DM(0.,a_0T1,a_1T1,a_2T1,MRT1_2,MRT12_2)*phi_T2(0., MRT2_2, MRT22_2) - a_1T2*z_DM(0.) - a_2T2*z_DM(0.)*z_DM(0.);

                a_1T0 = mySM.getOptionalParameter("a_1T0");
                a_2T0 = mySM.getOptionalParameter("a_2T0");
                MRT0_2 = mySM.getOptionalParameter("mBs1_1") * mySM.getOptionalParameter("mBs1_1");
                MRT02_2 = mySM.getOptionalParameter("mBs1_2") * mySM.getOptionalParameter("mBs1_2");
                a_0T0 = T2_DM(t_m,a_0T2,a_1T2,a_2T2,MRT2_2,MRT22_2)*phi_T0(t_m, MRT0_2, MRT02_2) - a_1T0*z_DM(t_m) - a_2T0*z_DM(t_m)*z_DM(t_m);
...
void MVll::checkCache()
{
    ...
    if (lep == QCD::NEUTRINO_1){
        H_V0updated = N_updated * VL0_updated * C_L_nunu_e_updated  * C_L_nunu_mu_updated  * C_L_nunu_tau_updated * C_R_nunu_e_updated * C_R_nunu_mu_updated * C_R_nunu_tau_updated * VR0_updated;
        H_V1updated = N_updated * VL1_updated * C_L_nunu_e_updated  * C_L_nunu_mu_updated  * C_L_nunu_tau_updated * C_R_nunu_e_updated * C_R_nunu_mu_updated * C_R_nunu_tau_updated * VR1_updated;
        H_V2updated = N_updated * VL2_updated * C_L_nunu_e_updated  * C_L_nunu_mu_updated  * C_L_nunu_tau_updated * C_R_nunu_e_updated * C_R_nunu_mu_updated * C_R_nunu_tau_updated * VR2_updated;
        H_A0updated = N_updated * VL0_updated * C_L_nunu_e_updated  * C_L_nunu_mu_updated  * C_L_nunu_tau_updated * C_R_nunu_e_updated * C_R_nunu_mu_updated * C_R_nunu_tau_updated * VR0_updated;
        H_A1updated = N_updated * VL1_updated * C_L_nunu_e_updated  * C_L_nunu_mu_updated  * C_L_nunu_tau_updated * C_R_nunu_e_updated * C_R_nunu_mu_updated * C_R_nunu_tau_updated * VR1_updated;
        H_A2updated = N_updated * VL2_updated * C_L_nunu_e_updated  * C_L_nunu_mu_updated  * C_L_nunu_tau_updated * C_R_nunu_e_updated * C_R_nunu_mu_updated * C_R_nunu_tau_updated * VR2_updated;
    } else { 
...
double MVll::phi_f(double q2, double MRf_2, double MRf2_2)
{
    double z = z_DM(q2);
...
double MVll::phi_g(double q2, double MRg_2, double MRg2_2)
{
    double z = z_DM(q2);
    double z_M = z_DM(MRg_2);
    double z_M2 = z_DM(MRg2_2);

    return 16.*rV*rV*sqrt(n_I/3./Chi1minus/M_PI) * (1. + z)*(1. + z)*pow(1. - z,-0.5)/pow((1. + rV)*(1. - z)+2.*sqrt(rV)*(1. + z),4) * (z - z_M)/(1. - z_M*z) * (z - z_M2)/(1. - z_M2*z);
}

double MVll::phi_F1(double q2, double MRF1_2, double MRF12_2)
{
    double z = z_DM(q2);
    double z_M = z_DM(MRF1_2);
    double z_M2 = z_DM(MRF12_2);

    if (vectorM == StandardModel::PHI)
        return 2.*rV/MM3*sqrt(2.*n_I/3./Chi1plus/M_PI) * (1. + z)*pow(1. - z,2.5)/pow((1. + rV)*(1. - z)+2.*sqrt(rV)*(1. + z),5) * (z - z_M)/(1. - z_M*z) * (z - z_M2)/(1. - z_M2*z);
    else
        return 2.*rV/MM3*sqrt(2.*n_I/3./Chi1plus/M_PI) * (1. + z)*pow(1. - z,2.5)/pow((1. + rV)*(1. - z)+2.*sqrt(rV)*(1. + z),5) * (z - z_M)/(1. - z_M*z);
}

double MVll::phi_F2(double q2, double MRF2_2, double MRF22_2)
{
    double z = z_DM(q2);
    double z_M = z_DM(MRF2_2);
    double z_M2 = z_DM(MRF22_2);

    return 8.*rV*rV*sqrt(2.*n_I/Chi0minus/M_PI) * (1. + z)*(1. + z)*pow(1. - z,-0.5)/pow((1. + rV)*(1. - z)+2.*sqrt(rV)*(1. + z),4) * (z - z_M)/(1. - z_M*z) * (z - z_M2)/(1. - z_M2*z);
}

double MVll::phi_T0(double q2, double MRT0_2, double MRT02_2)
{
    double z = z_DM(q2);
    double z_M = z_DM(MRT0_2);
    double z_M2 = z_DM(MRT02_2);

    if (vectorM == StandardModel::PHI)
        return 2.*rV*(1. + rV)/MM*sqrt(2.*n_I/3./ChiBB/M_PI) * (1. + z)*pow(1. - z,1.5)/pow((1. + rV)*(1. - z)+2.*sqrt(rV)*(1. + z),4) * (z - z_M)/(1. - z_M*z) * (z - z_M2)/(1. - z_M2*z);
    else
        return 2.*rV*(1. + rV)/MM*sqrt(2.*n_I/3./ChiBB/M_PI) * (1. + z)*pow(1. - z,1.5)/pow((1. + rV)*(1. - z)+2.*sqrt(rV)*(1. + z),4) * (z - z_M)/(1. - z_M*z);
}

double MVll::phi_T1(double q2, double MRT1_2, double MRT12_2)
{
    double z = z_DM(q2);
    double z_M = z_DM(MRT1_2);
    double z_M2 = z_DM(MRT12_2);

    return 32.*rV*rV/MM*sqrt(n_I/3./ChiTT/M_PI) * (1. + z)*(1. + z)*pow(1. - z,0.5)/pow((1. + rV)*(1. - z)+2.*sqrt(rV)*(1. + z),5) * (z - z_M)/(1. - z_M*z) * (z - z_M2)/(1. - z_M2*z);
}

double MVll::phi_T2(double q2, double MRT2_2, double MRT22_2)
{
    double z = z_DM(q2);
    double z_M = z_DM(MRT2_2);
    double z_M2 = z_DM(MRT22_2);

    if (vectorM == StandardModel::PHI)
        return 4.*rV*(1. - rV*rV)/MM*sqrt(n_I/3./ChiBB/M_PI) * (1. + z)*pow(1. - z,2.5)/pow((1. + rV)*(1. - z)+2.*sqrt(rV)*(1. + z),5) * (z - z_M)/(1. - z_M*z) * (z - z_M2)/(1. - z_M2*z);
    else
        return 4.*rV*(1. - rV*rV)/MM*sqrt(n_I/3./ChiBB/M_PI) * (1. + z)*pow(1. - z,2.5)/pow((1. + rV)*(1. - z)+2.*sqrt(rV)*(1. + z),5) * (z - z_M)/(1. - z_M*z);
}

double MVll::f_DM(double q2, double a_0f, double a_1f, double a_2f, double MRf_2, double MRf2_2)
{
    double z = z_DM(q2);
    return (a_0f + a_1f*z + a_2f*z*z) / phi_f(q2, MRf_2, MRf2_2);
}

double MVll::g_DM(double q2, double a_0g, double a_1g, double a_2g, double MRg_2, double MRg2_2)
{
    double z = z_DM(q2);
    return (a_0g + a_1g*z + a_2g*z*z) / phi_g(q2, MRg_2, MRg2_2);
}

double MVll::F1_DM(double q2, double a_0F1, double a_1F1, double a_2F1, double MRF1_2, double MRF12_2)
{
    double z = z_DM(q2);
    return (a_0F1 + a_1F1*z + a_2F1*z*z) / phi_F1(q2, MRF1_2, MRF12_2);
}

double MVll::F2_DM(double q2, double a_0F2, double a_1F2, double a_2F2, double MRF2_2, double MRF22_2)
{
    double z = z_DM(q2);
    return (a_0F2 + a_1F2*z + a_2F2*z*z) / phi_F2(q2, MRF2_2, MRF22_2);
}

double MVll::T0_DM(double q2, double a_0T0, double a_1T0, double a_2T0, double MRT0_2, double MRT02_2)
{
    double z = z_DM(q2);
    return (a_0T0 + a_1T0*z + a_2T0*z*z) / phi_T0(q2, MRT0_2, MRT02_2);
}

double MVll::T1_DM(double q2, double a_0T1, double a_1T1, double a_2T1, double MRT1_2, double MRT12_2)
{
    double z = z_DM(q2);
    return (a_0T1 + a_1T1*z + a_2T1*z*z) / phi_T1(q2, MRT1_2, MRT12_2);
}

double MVll::T2_DM(double q2, double a_0T2, double a_1T2, double a_2T2, double MRT2_2, double MRT22_2)
{
    double z = z_DM(q2);
    return (a_0T2 + a_1T2*z + a_2T2*z*z) / phi_T2(q2, MRT2_2, MRT22_2);
}

double MVll::V(double q2)
{
    if (MVll_DM_flag) {
        return g_DM(q2, a_0g, a_1g, a_2g, MRg_2, MRg2_2)*MMpMV/2.;
    } else {
...
{
    if (MVll_DM_flag) {
        return F2_DM(q2, a_0F2, a_1F2, a_2F2, MRF2_2, MRF22_2)/2.;
    } else {
...
{
    if (MVll_DM_flag) {
        return f_DM(q2, a_0f, a_1f, a_2f, MRf_2, MRf2_2)/MMpMV;
    } else {
...
double MVll::A_2(double q2)
{
    double A12 = 0.;
    if (MVll_DM_flag) {
        A12 = F1_DM(q2, a_0F1, a_1F1, a_2F1, MRF1_2, MRF12_2)/MMMV/8.;
    } else {
...
{
    if (MVll_DM_flag) {
        return T1_DM(q2, a_0T1, a_1T1, a_2T1, MRT1_2, MRT12_2);
    } else {
...
{
    if (MVll_DM_flag) {
        return T2_DM(q2, a_0T2, a_1T2, a_2T2, MRT2_2, MRT22_2);
    } else {
...
double MVll::T_0t(double q2)
{
    double T23 = 0.;
    if (MVll_DM_flag) {
        T23 = T0_DM(q2, a_0T0, a_1T0, a_2T0, MRT0_2, MRT02_2)*MMpMV*MMpMV/4./MM/MV;
    } else {
...
{
    FS = convertToGslFunction(bind(&MVll::T_perp_real, &(*this), q2, _1, conjugate));
...
{
    FS = convertToGslFunction(bind(&MVll::T_perp_imag, &(*this), q2, _1, conjugate));
    gsl_integration_cquad(&FS, 0., 1., 1.e-2, 1.e-1, w_sigma, &avaSigma, &errSigma, NULL);
...
{
    FS = convertToGslFunction(bind(&MVll::T_para_real, &(*this), q2, _1, conjugate));
    gsl_integration_cquad(&FS, 0., 1., 1.e-2, 1.e-1, w_sigma, &avaSigma, &errSigma, NULL);
...
{
    FS = convertToGslFunction(bind(&MVll::T_para_imag, &(*this), q2, _1, conjugate));
    gsl_integration_cquad(&FS, 0., 1., 1.e-2, 1.e-1, w_sigma, &avaSigma, &errSigma, NULL);
...
gslpp::complex MVll::H_0_nunu(double q2, bool bar, QCD::lepton lep)
{
    if (lep == QCD::NEUTRINO_1) {
        if (!bar) return -gslpp::complex::i() * NN * (C_L_nunu_e - etaV * pow(-1, angmomV) * C_R_nunu_e) * V_0t(q2);
        return -gslpp::complex::i() * NN_conjugate * (C_L_nunu_e.conjugate() - etaV * pow(-1, angmomV) * C_R_nunu_e.conjugate()) * V_0t(q2);
    } else if (lep == QCD::NEUTRINO_2) {
        if (!bar) return -gslpp::complex::i() * NN * (C_L_nunu_mu - etaV * pow(-1, angmomV) * C_R_nunu_mu) * V_0t(q2);
        return -gslpp::complex::i() * NN_conjugate * (C_L_nunu_mu.conjugate() - etaV * pow(-1, angmomV) * C_R_nunu_mu.conjugate()) * V_0t(q2);
    } else if (lep == QCD::NEUTRINO_3) {
        if (!bar) return -gslpp::complex::i() * NN * (C_L_nunu_tau - etaV * pow(-1, angmomV) * C_R_nunu_tau) * V_0t(q2);
        return -gslpp::complex::i() * NN_conjugate * (C_L_nunu_tau.conjugate() - etaV * pow(-1, angmomV) * C_R_nunu_tau.conjugate()) * V_0t(q2);
    } 
}

gslpp::complex MVll::H_p_nunu(double q2, bool bar, QCD::lepton lep)
{
    if (lep == QCD::NEUTRINO_1) {
        if (!bar) return -gslpp::complex::i() * NN * (C_L_nunu_e * V_p(q2) - etaV * pow(-1, angmomV) * C_R_nunu_e * V_m(q2));
        return -gslpp::complex::i() * NN_conjugate * (C_L_nunu_e.conjugate() * V_p(q2) - etaV * pow(-1, angmomV) * C_R_nunu_e.conjugate() * V_m(q2));
    } else if (lep == QCD::NEUTRINO_2) {
        if (!bar) return -gslpp::complex::i() * NN * (C_L_nunu_mu * V_p(q2) - etaV * pow(-1, angmomV) * C_R_nunu_mu * V_m(q2));
        return -gslpp::complex::i() * NN_conjugate * (C_L_nunu_mu.conjugate() * V_p(q2) - etaV * pow(-1, angmomV) * C_R_nunu_mu.conjugate() * V_m(q2));
    } else if (lep == QCD::NEUTRINO_3) {
        if (!bar) return -gslpp::complex::i() * NN * (C_L_nunu_tau * V_p(q2) - etaV * pow(-1, angmomV) * C_R_nunu_tau * V_m(q2));
        return -gslpp::complex::i() * NN_conjugate * (C_L_nunu_tau.conjugate() * V_p(q2) - etaV * pow(-1, angmomV) * C_R_nunu_tau.conjugate() * V_m(q2));
    } 
}

gslpp::complex MVll::H_m_nunu(double q2, bool bar, QCD::lepton lep)
{
    if (lep == QCD::NEUTRINO_1) {
        if (!bar) return -gslpp::complex::i() * NN * (C_L_nunu_e * V_m(q2) - etaV * pow(-1, angmomV) * C_R_nunu_e * V_p(q2));
        return -gslpp::complex::i() * NN_conjugate * (C_L_nunu_e.conjugate() * V_m(q2) - etaV * pow(-1, angmomV) * C_R_nunu_e.conjugate() * V_p(q2));
    } else if (lep == QCD::NEUTRINO_2) {
        if (!bar) return -gslpp::complex::i() * NN * (C_L_nunu_mu * V_m(q2) - etaV * pow(-1, angmomV) * C_R_nunu_mu * V_p(q2));
        return -gslpp::complex::i() * NN_conjugate * (C_L_nunu_mu.conjugate() * V_m(q2) - etaV * pow(-1, angmomV) * C_R_nunu_mu.conjugate() * V_p(q2));
    } else if (lep == QCD::NEUTRINO_3) {
        if (!bar) return -gslpp::complex::i() * NN * (C_L_nunu_tau * V_m(q2) - etaV * pow(-1, angmomV) * C_R_nunu_tau * V_p(q2));
        return -gslpp::complex::i() * NN_conjugate * (C_L_nunu_tau.conjugate() * V_m(q2) - etaV * pow(-1, angmomV) * C_R_nunu_tau.conjugate() * V_p(q2));
    } 
}
...
{
    if (lep == QCD::NEUTRINO_1) 
        return F(q2, b)*H_0_nunu(q2, bar, QCD::NEUTRINO_1).abs2() + F(q2, b)*H_0_nunu(q2, bar, QCD::NEUTRINO_2).abs2() + F(q2, b)*H_0_nunu(q2, bar, QCD::NEUTRINO_3).abs2();
    else return F(q2, b)*((H_V_0(q2, bar).abs2() + H_A_0(q2, bar).abs2()) / 2. + H_P(q2, bar).abs2() + 2. * Mlep2 / q2 * (H_V_0(q2, bar).abs2()
...
{
    if (lep == QCD::NEUTRINO_1) 
        return F(q2, b) * 3. / 4. * (H_p_nunu(q2, bar, QCD::NEUTRINO_1).abs2() + H_m_nunu(q2, bar, QCD::NEUTRINO_1).abs2()) +
            F(q2, b) * 3. / 4. * (H_p_nunu(q2, bar, QCD::NEUTRINO_2).abs2() + H_m_nunu(q2, bar, QCD::NEUTRINO_2).abs2()) +
            F(q2, b) * 3. / 4. * (H_p_nunu(q2, bar, QCD::NEUTRINO_3).abs2() + H_m_nunu(q2, bar, QCD::NEUTRINO_3).abs2());
    else return F(q2, b)*((beta2(q2) + 2.) / 8. * (H_V_p(q2, bar).abs2() + H_V_m(q2, bar).abs2() + H_A_p(q2, bar).abs2() + H_A_m(q2, bar).abs2()) +
...
double MVll::I_2c(double q2, bool bar)
{
    if (lep == QCD::NEUTRINO_1) 
        return - F(q2, b)*H_0_nunu(q2, bar, QCD::NEUTRINO_1).abs2() - F(q2, b)*H_0_nunu(q2, bar, QCD::NEUTRINO_2).abs2() - F(q2, b)*H_0_nunu(q2, bar, QCD::NEUTRINO_3).abs2();
    else return -F(q2, b) * beta2(q2) / 2. * (H_V_0(q2, bar).abs2() + H_A_0(q2, bar).abs2());
}

double MVll::I_2s(double q2, bool bar)
{
    if (lep == QCD::NEUTRINO_1) 
        return F(q2, b) / 4. * (H_p_nunu(q2, bar, QCD::NEUTRINO_1).abs2() + H_m_nunu(q2, bar, QCD::NEUTRINO_1).abs2()) +
            F(q2, b) / 4. * (H_p_nunu(q2, bar, QCD::NEUTRINO_2).abs2() + H_m_nunu(q2, bar, QCD::NEUTRINO_2).abs2()) +
            F(q2, b) / 4. * (H_p_nunu(q2, bar, QCD::NEUTRINO_3).abs2() + H_m_nunu(q2, bar, QCD::NEUTRINO_3).abs2());
    else return F(q2, b) * beta2(q2) / 8. * (H_V_p(q2, bar).abs2() + H_V_m(q2, bar).abs2() + H_A_p(q2, bar).abs2() + H_A_m(q2, bar).abs2());
}
    ...
    switch (i) {
        case 0:
            if (sigma0Cached[qbin] == 0) {
                FS = convertToGslFunction(bind(&MVll::getSigma1c, &(*this), _1));
        ...
        case 1:
            if (sigma1Cached[qbin] == 0) {
                FS = convertToGslFunction(bind(&MVll::getSigma1s, &(*this), _1));
                if (gsl_integration_cquad(&FS, q_min, q_max, 1.e-2, 1.e-1, w_sigma, &avaSigma, &errSigma, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 2:
            if (sigma2Cached[qbin] == 0) {
                FS = convertToGslFunction(bind(&MVll::getSigma2c, &(*this), _1));
                if (gsl_integration_cquad(&FS, q_min, q_max, 1.e-2, 1.e-1, w_sigma, &avaSigma, &errSigma, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 3:
            if (sigma3Cached[qbin] == 0) {
                FS = convertToGslFunction(bind(&MVll::getSigma2s, &(*this), _1));
                if (gsl_integration_cquad(&FS, q_min, q_max, 1.e-2, 1.e-1, w_sigma, &avaSigma, &errSigma, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 4:
            if (sigma4Cached[qbin] == 0) {
                FS = convertToGslFunction(bind(&MVll::getSigma3, &(*this), _1));
                if (gsl_integration_cquad(&FS, q_min, q_max, 1.e-2, 1.e-1, w_sigma, &avaSigma, &errSigma, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 5:
            if (sigma5Cached[qbin] == 0) {
                FS = convertToGslFunction(bind(&MVll::getSigma4, &(*this), _1));
                if (gsl_integration_cquad(&FS, q_min, q_max, 1.e-2, 1.e-1, w_sigma, &avaSigma, &errSigma, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 6:
            if (sigma6Cached[qbin] == 0) {
                FS = convertToGslFunction(bind(&MVll::getSigma5, &(*this), _1));
                if (gsl_integration_cquad(&FS, q_min, q_max, 1.e-2, 1.e-1, w_sigma, &avaSigma, &errSigma, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 7:
            if (sigma7Cached[qbin] == 0) {
                FS = convertToGslFunction(bind(&MVll::getSigma6s, &(*this), _1));
                if (gsl_integration_cquad(&FS, q_min, q_max, 1.e-2, 1.e-1, w_sigma, &avaSigma, &errSigma, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 10:
            if (sigma10Cached[qbin] == 0) {
                FS = convertToGslFunction(bind(&MVll::getSigma8, &(*this), _1));
                if (gsl_integration_cquad(&FS, q_min, q_max, 1.e-2, 1.e-1, w_sigma, &avaSigma, &errSigma, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 11:
            if (sigma11Cached[qbin] == 0) {
                FS = convertToGslFunction(bind(&MVll::getSigma9, &(*this), _1));
                if (gsl_integration_cquad(&FS, q_min, q_max, 1.e-2, 1.e-1, w_sigma, &avaSigma, &errSigma, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
    ...
    switch (i) {
        case 0:
            if (delta0Cached[qbin] == 0) {
                FD = convertToGslFunction(bind(&MVll::getDelta1c, &(*this), _1));
        ...
        case 1:
            if (delta1Cached[qbin] == 0) {
                FD = convertToGslFunction(bind(&MVll::getDelta1s, &(*this), _1));
                if (gsl_integration_cquad(&FD, q_min, q_max, 1.e-2, 1.e-1, w_delta, &avaDelta, &errDelta, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 2:
            if (delta2Cached[qbin] == 0) {
                FD = convertToGslFunction(bind(&MVll::getDelta2c, &(*this), _1));
                if (gsl_integration_cquad(&FD, q_min, q_max, 1.e-2, 1.e-1, w_delta, &avaDelta, &errDelta, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 3:
            if (delta3Cached[qbin] == 0) {
                FD = convertToGslFunction(bind(&MVll::getDelta2s, &(*this), _1));
                if (gsl_integration_cquad(&FD, q_min, q_max, 1.e-2, 1.e-1, w_delta, &avaDelta, &errDelta, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 6:
            if (delta6Cached[qbin] == 0) {
                FD = convertToGslFunction(bind(&MVll::getDelta5, &(*this), _1));
                if (gsl_integration_cquad(&FD, q_min, q_max, 1.e-2, 1.e-1, w_delta, &avaDelta, &errDelta, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 7:
            if (delta7Cached[qbin] == 0) {
                FD = convertToGslFunction(bind(&MVll::getDelta6s, &(*this), _1));
                if (gsl_integration_cquad(&FD, q_min, q_max, 1.e-2, 1.e-1, w_delta, &avaDelta, &errDelta, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 8:
            if (delta8Cached[qbin] == 0) {
                FD = convertToGslFunction(bind(&MVll::getDelta6c, &(*this), _1));
                if (gsl_integration_cquad(&FD, q_min, q_max, 1.e-2, 1.e-1, w_delta, &avaDelta, &errDelta, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 10:
            if (delta10Cached[qbin] == 0) {
                FD = convertToGslFunction(bind(&MVll::getDelta8, &(*this), _1));
                if (gsl_integration_cquad(&FD, q_min, q_max, 1.e-2, 1.e-1, w_delta, &avaDelta, &errDelta, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
        ...
        case 11:
            if (delta11Cached[qbin] == 0) {
                FD = convertToGslFunction(bind(&MVll::getDelta9, &(*this), _1));
                if (gsl_integration_cquad(&FD, q_min, q_max, 1.e-2, 1.e-1, w_delta, &avaDelta, &errDelta, NULL) != 0) return std::numeric_limits<double>::quiet_NaN();
