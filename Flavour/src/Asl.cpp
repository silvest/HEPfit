...
double Asl_d_pole::computeThValue() {
    return -SM.getFlavour().getDB2(0).getGamma21overM21(FULLNNLO, SM.getFlavour().getDB2(0).pole).imag();
}
...
double Asl_s_pole::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21(FULLNNLO, SM.getFlavour().getDB2(1).pole).imag();
}
...
double Asl_s_pole_NLO::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21(FULLNLO, SM.getFlavour().getDB2(1).pole).imag();
}
...
double Asl_s_pole_LO::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21(LO, SM.getFlavour().getDB2(1).pole).imag();
}
...
double Asl_s_MSbar::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21(FULLNNLO, SM.getFlavour().getDB2(1).MSbar).imag();
}
...
double Asl_s_MSbar_NLO::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21(FULLNLO, SM.getFlavour().getDB2(1).MSbar).imag();
}
...
double Asl_s_MSbar_LO::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21(LO, SM.getFlavour().getDB2(1).MSbar).imag();
}
...
double Asl_d_PS::computeThValue() {
    return -SM.getFlavour().getDB2(0).getGamma21overM21(FULLNNLO, SM.getFlavour().getDB2(0).PS).imag();
}
...
double Asl_s_PS::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21(FULLNNLO, SM.getFlavour().getDB2(1).PS).imag();
}
...
double Asl_s_PS_NLO::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21(FULLNLO, SM.getFlavour().getDB2(1).PS).imag();
}
...
double Asl_s_PS_LO::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21(LO, SM.getFlavour().getDB2(1).PS).imag();
}
...
double Asl_s_pole_fixmub::computeThValue() {
    return -SM.getFlavour().getDB2(1,true).getGamma21overM21(FULLNNLO, SM.getFlavour().getDB2(1,true).pole).imag();
}
...
double Asl_s_MSbar_fixmub::computeThValue() {
    return -SM.getFlavour().getDB2(1,true).getGamma21overM21(FULLNNLO, SM.getFlavour().getDB2(1,true).MSbar).imag();
}
...
double Asl_s_PS_fixmub::computeThValue() {
    return -SM.getFlavour().getDB2(1,true).getGamma21overM21(FULLNNLO, SM.getFlavour().getDB2(1,true).PS).imag();
}
...
double Asl_d_only1overmb::computeThValue() {
    return -SM.getFlavour().getDB2(0).getGamma21overM21(FULLNNLO, SM.getFlavour().getDB2(0).only1overmb).imag();
}
...
double Asl_s_only1overmb::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21(FULLNNLO, SM.getFlavour().getDB2(1).only1overmb).imag();
}
...
double Asl_d_MSbar_NLO_tradBasis::computeThValue() {
    return -SM.getFlavour().getDB2(0).getGamma21overM21_tradBasis(FULLNLO).imag();
}
...
double Asl_s_MSbar_NLO_tradBasis::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21_tradBasis(FULLNLO).imag();
}
...
double Asl_s_MSbar_NLO_RI::computeThValue() {
    return -SM.getFlavour().getDB2(1,false, true).getGamma21overM21(FULLNLO, SM.getFlavour().getDB2(1,false, true).MSbar).imag();
}
...
double Asl_s_MSbar_partialNNLO::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21(FULLNNLO, SM.getFlavour().getDB2(1).MSbar_partialNNLO).imag();
}
...
double Asl_s_PS_partialNNLO::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21(FULLNNLO, SM.getFlavour().getDB2(1).PS_partialNNLO).imag();
}
...
double Asl_s_MSbar_partialN3LO::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21(FULLNNNLO, SM.getFlavour().getDB2(1).MSbar_partialN3LO).imag();
}
...
double Asl_s_PS_partialN3LO::computeThValue() {
    return -SM.getFlavour().getDB2(1).getGamma21overM21(FULLNNNLO, SM.getFlavour().getDB2(1).PS_partialN3LO).imag();
}