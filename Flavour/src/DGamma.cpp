...
double DGamma_s_MSbar_partialNNLO::computeThValue() {
    return -getGamma21overM21_Bs(FULLNNLO, MSbar_partialNNLO).real() * SM.getOptionalParameter("DmBs_ex");
}
...
double DGamma_s_PS_partialNNLO::computeThValue() {
    return -getGamma21overM21_Bs(FULLNNLO, PS_partialNNLO).real() * SM.getOptionalParameter("DmBs_ex");
}
...
double DGamma_s_MSbar_partialN3LO::computeThValue() {
    return -getGamma21overM21_Bs(FULLNNNLO, MSbar_partialN3LO).real() * SM.getOptionalParameter("DmBs_ex");
}
...
double DGamma_s_PS_partialN3LO::computeThValue() {
    return -getGamma21overM21_Bs(FULLNNNLO, PS_partialN3LO).real() * SM.getOptionalParameter("DmBs_ex");
}