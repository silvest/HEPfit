...

{
	...
	if(fabs(a[L][j] + y - 3. - a[L][p]) < cut && (a[L][p] + x - 3. - a[L][i]) < cut ){
	value = 0;
	}
        else if(fabs(a[L][j] + y - 3. - a[L][p]) < cut && (a[L][p] + x - 3. - a[L][i]) > cut){
	value = 1;	
	}
	else if(fabs(a[L][j] + y - 3. - a[L][p]) > cut && fabs(a[L][j] + y - 3. + x - 3. - a[L][i]) < cut 
                        &&  fabs(a[L][p] + x - 3. - a[L][i]) < cut ){
	value = 2;	
	}
        else if(fabs(a[L][j] + y - 3. - a[L][p]) > cut && fabs(a[L][j] + y - 3. + x - 3. - a[L][i]) > cut 
                        &&  fabs(a[L][p] + x - 3. - a[L][i]) > cut ){
...

{
	...
	if(fabs(a[L][p] + x - 3. - a[L][i]) < cut && fabs(a[L][q] + y - 3. - a[L][p]) < cut 
                && fabs(a[L][j] + z - 3. - a[L][q]) < cut){
	value = 0;
        }
	
        else if(fabs(a[L][p] + x - 3. - a[L][i]) > cut  && fabs(a[L][q] + y - 3. - a[L][p]) < cut 
                && fabs(a[L][j] + z - 3. - a[L][q]) < cut){
	value = 1;
        }
        ...
        else if(fabs(a[L][j] + z - 3. - a[L][q]) > cut){
	value = 6;
	}
