...
double BR_MVll::computeThValue()
{
    ...
    switch(vectorM){
            ...
            case StandardModel::K_star_P:
                return (computeGammaPrime(q_min, q_max, lep)/SM.getFlavour().getMVll(meson, vectorM, lep).getwidth() + SM.getFlavour().getMVll(meson, vectorM, lep).integrateSigmaTree(q_min, q_max)) / ( q_max - q_min );
                break;
...
double R_MVll::computeThValue()
{
    ...
    if (vectorM == StandardModel::PHI)
        return computeGammaPrime(q_min, q_max, lep2) / computeGammaPrime(q_min, q_max, lep1);
    else
...
S_1c::S_1c(const StandardModel& SM_i, QCD::meson meson_i, QCD::meson vector_i, QCD::lepton lep_i)
: GammaPrime(SM_i, meson_i, vector_i, lep_i)
{
    lep = lep_i;
    meson = meson_i;
...
double S_1c::computeThValue()
{
    double q_min = getBinMin();
    double q_max = getBinMax();

    return SM.getFlavour().getMVll(meson, vectorM, lep).integrateSigma(0,q_min,q_max) / computeGammaPrime(q_min, q_max, lep);
}


S_1s::S_1s(const StandardModel& SM_i, QCD::meson meson_i, QCD::meson vector_i, QCD::lepton lep_i)
: GammaPrime(SM_i, meson_i, vector_i, lep_i)
{
    lep = lep_i;
    meson = meson_i;
...
double S_1s::computeThValue()
{
    double q_min = getBinMin();
    double q_max = getBinMax();

    return SM.getFlavour().getMVll(meson, vectorM, lep).integrateSigma(1,q_min,q_max) / computeGammaPrime(q_min, q_max, lep);
}


S_2c::S_2c(const StandardModel& SM_i, QCD::meson meson_i, QCD::meson vector_i, QCD::lepton lep_i)
: GammaPrime(SM_i, meson_i, vector_i, lep_i)
{
    lep = lep_i;
    meson = meson_i;
...
double S_2c::computeThValue()
{
    double q_min = getBinMin();
    double q_max = getBinMax();

    return SM.getFlavour().getMVll(meson, vectorM, lep).integrateSigma(2,q_min,q_max) / computeGammaPrime(q_min, q_max, lep);
}


S_2s::S_2s(const StandardModel& SM_i, QCD::meson meson_i, QCD::meson vector_i, QCD::lepton lep_i)
: GammaPrime(SM_i, meson_i, vector_i, lep_i)
{
    lep = lep_i;
    meson = meson_i;
...
double S_2s::computeThValue()
{
    double q_min = getBinMin();
    double q_max = getBinMax();

    return SM.getFlavour().getMVll(meson, vectorM, lep).integrateSigma(3,q_min,q_max) / computeGammaPrime(q_min, q_max, lep);
}
...
S_6c::S_6c(const StandardModel& SM_i, QCD::meson meson_i, QCD::meson vector_i, QCD::lepton lep_i)
: GammaPrime(SM_i, meson_i, vector_i, lep_i)
{
    lep = lep_i;
    meson = meson_i;
...
double S_6c::computeThValue()
{
    double q_min = getBinMin();
    double q_max = getBinMax();

    return SM.getFlavour().getMVll(meson, vectorM, lep).integrateSigma(8,q_min,q_max) / computeGammaPrime(q_min, q_max, lep);
}
...
BR_MVpsi::BR_MVpsi(const StandardModel& SM_i, QCD::meson meson_i, QCD::meson vector_i, QCD::lepton lep_i)
: ThObservable(SM_i)
{
    lep = lep_i;
    meson = meson_i;
...
double BR_MVpsi::computeThValue()
{
    double q2 = getBinMin();
...
double BR_MVpsi_ratio::computeThValue()
{
    double A2_0_JPSI = SM.getFlavour().getMVll(meson, vectorM, lep).AmpMVpsi_zExpansion(3.0969,0).abs2();
    double A2_par_JPSI = SM.getFlavour().getMVll(meson, vectorM, lep).AmpMVpsi_zExpansion(3.0969,1).abs2();
    double A2_perp_JPSI = SM.getFlavour().getMVll(meson, vectorM, lep).AmpMVpsi_zExpansion(3.0969,2).abs2();

    double A2_0_PSI2S = SM.getFlavour().getMVll(meson, vectorM, lep).AmpMVpsi_zExpansion(3.6861,0).abs2();
    double A2_par_PSI2S = SM.getFlavour().getMVll(meson, vectorM, lep).AmpMVpsi_zExpansion(3.6861,1).abs2();
    double A2_perp_PSI2S = SM.getFlavour().getMVll(meson, vectorM, lep).AmpMVpsi_zExpansion(3.6861,2).abs2();

    return (A2_0_PSI2S+A2_par_PSI2S+A2_perp_PSI2S)/(A2_0_JPSI+A2_par_JPSI+A2_perp_JPSI);
}
...
double Abs2Ampzero_MVpsi::computeThValue()
{
    double q2 = getBinMin();
    double A2_0 = SM.getFlavour().getMVll(meson, vectorM, lep).AmpMVpsi_zExpansion(q2,0).abs2();
    double A2_par = SM.getFlavour().getMVll(meson, vectorM, lep).AmpMVpsi_zExpansion(q2,1).abs2();
