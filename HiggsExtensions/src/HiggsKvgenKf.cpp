...
double HiggsKvgenKf::mueeWBF(const double sqrt_s) const
{
...
double HiggsKvgenKf::mueeZH(const double sqrt_s) const
{
    return (computeKZ() * computeKZ());
}
...
double HiggsKvgenKf::mueettH(const double sqrt_s) const
{
    return (computeKt() * computeKt());
}
...
double HiggsKvgenKf::BrHmumuRatio() const
{
...
double HiggsKvgenKf::computeKmu() const
{
    return Kf;
}
