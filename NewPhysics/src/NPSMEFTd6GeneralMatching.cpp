...
void NPSMEFTd6GeneralMatching::updateLEFTGeneralParameters()
{
        ...
        //Z boson
        double gZbar2oMZ3 = mySMEFT.FlagMomVert * gZ2oMZ2 / mySMEFT.getMz();
        double gZbar2oMZ4 = mySMEFT.FlagMomProp * gZbar2oMZ3 / mySMEFT.getMz();
        double deltagZbar2oMZ4 = 2. * delta_gZbar - 2. * delta_MZ2;
        //W boson
        double g2bar2oMW3 = mySMEFT.FlagMomVert * g22oMW2 / mySMEFT.getMw();
        double g2bar2oMW4 = mySMEFT.FlagMomProp * g2bar2oMW3 / mySMEFT.getMw();
                ...
                for (int j = 0; j < 3; j++)
                {
                        ...
                        for (int k = 0; k < 3; k++)
                        {
                                ...
                                for (int l = 0; l < 3; l++)
                                {
                                        ...
                                        if (mySMEFT.FlagNewTerms) {
                                            CeeVLR.at(i).at(j).at(k).at(l) += (oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CeHR", i, l) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CeHI", i, l))*(mySMEFT.getSMEFTCoeffEW("YeR", k, j) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YeI", k, j)) + (3*v2*(mySMEFT.getSMEFTCoeffEW("CeHR", j, k) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CeHI", j, k)) - 2*(1 + 2*(mySMEFT.getSMEFTCoeffEW("CHbox") - 0.25 * mySMEFT.getSMEFTCoeffEW("CHD")) * v2 + deltaoneoMh2)*(mySMEFT.getSMEFTCoeffEW("YeR", k, j) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YeI", k, j)))*(mySMEFT.getSMEFTCoeffEW("YeR", l, i) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YeI", l, i))))/4.;
                                            ...
                                            CeeSRR.at(i).at(j).at(k).at(l) += -0.25*(oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CeHR", k, l) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CeHI", k, l))*(mySMEFT.getSMEFTCoeffEW("YeR", j, i) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YeI", j, i)) + (3*v2*(mySMEFT.getSMEFTCoeffEW("CeHR", i, j) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CeHI", i, j)) - 2*(1 + 2*(mySMEFT.getSMEFTCoeffEW("CHbox") - 0.25 * mySMEFT.getSMEFTCoeffEW("CHD")) * v2 + deltaoneoMh2)*(mySMEFT.getSMEFTCoeffEW("YeR", j, i) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YeI", j, i)))*(mySMEFT.getSMEFTCoeffEW("YeR", l, k) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YeI", l, k))));
                                        }
                                        for (int p = 0; p < 3; p++)
                                                for (int r = 0; r < 3; r++)
                                                {
                                                        ...
                                                        for (int s = 0; s < 3; s++)
                                                                for (int t = 0; t < 3; t++)
                                                                {
                                                                        ...
                                                                        CddVLL.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdLd(k,s) * (-0.125*(gZ2oMZ2*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHq1R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, t))*(mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r))) - (gZ2oMZ2*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r))*(mySMEFT.getSMEFTCoeffEW("CHq3R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, t)))/8. - (gZ2oMZ2*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHq1R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, r))*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, t)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, t))))/8.) * VdL(r,j) * VdL(t,l);
                                                                        CddVRR.at(i).at(j).at(k).at(l) += VdRd(i,p) * VdRd(k,s) * ((gZ2oMZ2*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHdR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", p, r))*(mySMEFT.getSMEFTCoeffEW("CHdR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", s, t)))/8.) * VdR(r,j) * VdR(t,l);
                                                                        CddV1LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * (-0.25*(gZ2oMZ2*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHdR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", s, t))*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, r)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r))))) * VdL(r,j) * VdR(t,l);
                                                                        if (mySMEFT.FlagNewTerms) {
                                                                            CddV1LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * ((oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", p, t))*(mySMEFT.getSMEFTCoeffEW("YdR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", s, r)) + (3*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", r, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", r, s)) - 2*(1 + 2*(mySMEFT.getSMEFTCoeffEW("CHbox") - 0.25 * mySMEFT.getSMEFTCoeffEW("CHD")) * v2 + deltaoneoMh2)*(mySMEFT.getSMEFTCoeffEW("YdR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", s, r)))*(mySMEFT.getSMEFTCoeffEW("YdR", t, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", t, p))))/12.) * VdL(r,j) * VdR(t,l);
                                                                            CddV8LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * ((oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", p, t))*(mySMEFT.getSMEFTCoeffEW("YdR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", s, r)) + (3*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", r, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", r, s)) - 2*(1 + 2*(mySMEFT.getSMEFTCoeffEW("CHbox") - 0.25 * mySMEFT.getSMEFTCoeffEW("CHD")) * v2 + deltaoneoMh2)*(mySMEFT.getSMEFTCoeffEW("YdR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", s, r)))*(mySMEFT.getSMEFTCoeffEW("YdR", t, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", t, p))))/2.) * VdL(r,j) * VdR(t,l);
                                                                            CddS1RR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdLd(k,s) * (-0.25*(oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", s, t))*(mySMEFT.getSMEFTCoeffEW("YdR", r, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", r, p)) + (3*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", p, r)) - 2*(1 + 2*(mySMEFT.getSMEFTCoeffEW("CHbox") - 0.25 * mySMEFT.getSMEFTCoeffEW("CHD")) * v2 + deltaoneoMh2)*(mySMEFT.getSMEFTCoeffEW("YdR", r, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", r, p)))*(mySMEFT.getSMEFTCoeffEW("YdR", t, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", t, s))))) * VdR(r,j) * VdR(t,l);
                                                                            CddVLL.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(sbar*(mySMEFT.getSMEFTCoeffEW("CdBR", t, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdBI", t, s)) + cbar*(mySMEFT.getSMEFTCoeffEW("CdWR", t, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdWI", t, s)))*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, r)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r)))*Md[k])/(8.*sqrt(2))) * VdL(r,j) * VdL(t,l);
                                                                            CddVLL.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdLd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(sbar*(mySMEFT.getSMEFTCoeffEW("CdBR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdBI", s, t)) + cbar*(mySMEFT.getSMEFTCoeffEW("CdWR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdWI", s, t)))*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, r)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r)))*Md[l])/(8.*sqrt(2))) * VdL(r,j) * VdR(t,l);
                                                                            CddVLL.at(i).at(j).at(k).at(l) += VdRd(i,p) * VdLd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(sbar*(mySMEFT.getSMEFTCoeffEW("CdBR", r, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdBI", r, p)) + cbar*(mySMEFT.getSMEFTCoeffEW("CdWR", r, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdWI", r, p)))*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, t)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, t)))*Md[i])/(8.*sqrt(2))) * VdL(r,j) * VdL(t,l);
                                                                            CddVLL.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdLd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(sbar*(mySMEFT.getSMEFTCoeffEW("CdBR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdBI", p, r)) + cbar*(mySMEFT.getSMEFTCoeffEW("CdWR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdWI", p, r)))*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, t)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, t)))*Md[j])/(8.*sqrt(2))) * VdR(r,j) * VdL(t,l);
                                                                            CddVRR.at(i).at(j).at(k).at(l) += VdRd(i,p) * VdRd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(sbar*(mySMEFT.getSMEFTCoeffEW("CdBR", t, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdBI", t, s)) + cbar*(mySMEFT.getSMEFTCoeffEW("CdWR", t, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdWI", t, s)))*(mySMEFT.getSMEFTCoeffEW("CHdR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", p, r))*Md[l])/(4.*sqrt(2)))* VdR(r,j) * VdL(t,l);
                                                                            CddVRR.at(i).at(j).at(k).at(l) += VdRd(i,p) * VdLd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(sbar*(mySMEFT.getSMEFTCoeffEW("CdBR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdBI", s, t)) + cbar*(mySMEFT.getSMEFTCoeffEW("CdWR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdWI", s, t)))*(mySMEFT.getSMEFTCoeffEW("CHdR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", p, r))*Md[k])/(4.*sqrt(2))) * VdR(r,j) * VdR(t,l);
                                                                            CddVRR.at(i).at(j).at(k).at(l) += VdRd(i,p) * VdRd(k,s) *((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(sbar*(mySMEFT.getSMEFTCoeffEW("CdBR", r, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdBI", r, p)) + cbar*(mySMEFT.getSMEFTCoeffEW("CdWR", r, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdWI", r, p)))*(mySMEFT.getSMEFTCoeffEW("CHdR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", s, t))*Md[j])/(4.*sqrt(2))) * VdL(r,j) * VdR(t,l);
                                                                            CddVRR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) *((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(sbar*(mySMEFT.getSMEFTCoeffEW("CdBR", p ,r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdBI", p ,r)) + cbar*(mySMEFT.getSMEFTCoeffEW("CdWR", p ,r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdWI", p ,r)))*(mySMEFT.getSMEFTCoeffEW("CHdR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", s, t))*Md[i])/(4.*sqrt(2))) * VdR(r,j) * VdR(t,l);
                                                                            CddV1LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * (-0.041666666666666664*(oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", p, t))*(3*mySMEFT.FlagQuadraticWC*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", r, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", r, s)))))) * VdL(r,j) * VdR(t,l);
                                                                            CddV1LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(sbar*(mySMEFT.getSMEFTCoeffEW("CdBR", t, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdBI", t, s)) + cbar*(mySMEFT.getSMEFTCoeffEW("CdWR", t, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdWI", t, s)))*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, r)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r)))*Md[l])/(2.*sqrt(2))) * VdL(r,j) * VdR(t,l);
                                                                            CddV1LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(sbar*(mySMEFT.getSMEFTCoeffEW("CdBR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdBI", s, t)) + cbar*(mySMEFT.getSMEFTCoeffEW("CdWR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdWI", s, t)))*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, r)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r)))*Md[k])/(2.*sqrt(2))) * VdL(r,j) * VdR(t,l);
                                                                            CddV1LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(sbar*(mySMEFT.getSMEFTCoeffEW("CdBR", r, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdBI", r, p)) + cbar*(mySMEFT.getSMEFTCoeffEW("CdWR", r, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdWI", r, p)))*(mySMEFT.getSMEFTCoeffEW("CHdR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", s, t))*Md[i])/(2.*sqrt(2))) * VdL(r,j) * VdR(t,l);
                                                                            CddV1LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(sbar*(mySMEFT.getSMEFTCoeffEW("CdBR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdBI", p, r)) + cbar*(mySMEFT.getSMEFTCoeffEW("CdWR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdWI", p, r)))*(mySMEFT.getSMEFTCoeffEW("CHdR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", s, t))*Md[j])/(2.*sqrt(2))) * VdL(r,j) * VdR(t,l);
                                                                            CddV1LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * (-0.041666666666666664*(gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, r)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, r)))*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, t)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, t)))*Md[k]*Md[l])) * VdL(r,j) * VdR(t,l);
                                                                            CddV1LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * ((gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHdR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", s, r))*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, t)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, t)))*Md[j]*Md[l])/24.) * VdL(r,j) * VdR(t,l);
                                                                            CddV1LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * ((gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHdR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", p, t))*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, r)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, r)))*Md[i]*Md[k])/24.) * VdL(r,j) * VdR(t,l);
                                                                            CddV1LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * (-0.041666666666666664*(gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHdR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", p, t))*(mySMEFT.getSMEFTCoeffEW("CHdR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", s, r))*Md[i]*Md[j])) * VdL(r,j) * VdR(t,l);
                                                                            CddV8LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * (-0.25*(oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", p, t))*(3*mySMEFT.FlagQuadraticWC*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", r, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", r, s)))))) * VdL(r,j) * VdR(t,l);
                                                                            CddV8LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * (-0.25*(gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, r)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, r)))*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, t)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, t)))*Md[k]*Md[l])) * VdL(r,j) * VdR(t,l);
                                                                            CddV8LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * ((gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHdR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", s, r))*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, t)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, t)))*Md[j]*Md[l])/4.) * VdL(r,j) * VdR(t,l);
                                                                            CddV8LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * ((gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHdR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", p, t))*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, r)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, r)))*Md[i]*Md[k])/4.) * VdL(r,j) * VdR(t,l);
                                                                            CddV8LR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdRd(k,s) * (-0.25*(gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHdR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", p, t))*(mySMEFT.getSMEFTCoeffEW("CHdR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", s, r))*Md[i]*Md[j])) * VdL(r,j) * VdR(t,l);
                                                                            CddS1RR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdLd(k,s) * ((oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", p, r))*(3*mySMEFT.FlagQuadraticWC*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", s, t)))))/8.) * VdR(r,j) * VdR(t,l);
                                                                            ...
                                                                            CddS1RR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdLd(k,s) * (-0.25*(gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, r)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r)))*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, t)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, t)))*Md[j]*Md[l])) * VdR(r,j) * VdR(t,l);
                                                                            CddS1RR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdLd(k,s) * (-0.25*(gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHdR", p ,r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", p ,r))*(mySMEFT.getSMEFTCoeffEW("CHdR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", s, t))*Md[i]*Md[k])) * VdR(r,j) * VdR(t,l);
                                                                            CddS1RR.at(i).at(j).at(k).at(l) += VdLd(i,p) * VdLd(k,s) * ((gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHdR", p ,r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHdI", p ,r))*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, t)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, t)))*Md[i]*Md[l])/4.) * VdR(r,j) * VdR(t,l);
                                                                        }
                                                                }
                                                }
                                }
                                        ...
                                        for (int p = 0; p < 3; p++)
                                                for (int r = 0; r < 3; r++)
                                                {
                                                        ...
                                                        if (mySMEFT.FlagNewTerms) {
                                                            ...
                                                            CeuSRR.at(i).at(j).at(k).at(l) += VuLd(k,p) * (-0.5*(oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CuHR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuHI", p, r))*(mySMEFT.getSMEFTCoeffEW("YeR", j, i) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YeI", j, i)) + (3*v2*(mySMEFT.getSMEFTCoeffEW("CeHR", i, j) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CeHI", i, j)) - 2*(1 + 2*(mySMEFT.getSMEFTCoeffEW("CHbox") - 0.25 * mySMEFT.getSMEFTCoeffEW("CHD")) * v2 + deltaoneoMh2)*(mySMEFT.getSMEFTCoeffEW("YeR", j, i) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YeI", j, i)))*(mySMEFT.getSMEFTCoeffEW("YuR", r, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YuI", r, p))))) * VuR(r,l);
                                                        }
                                                        for (int s = 0; s < 3; s++)
                                                                for (int t = 0; t < 3; t++)
                                                                {
                                                ...
                                                for (int r = 0; r < 3; r++)
                                                {
                                                        ...
                                                        for (int s = 0; s < 3; s++)
                                                                for (int t = 0; t < 3; t++)
                                                                {
                                                                        ...
                                                                        if (mySMEFT.FlagNewTerms) {
                                                                            CudduV1LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VdRd(k,s) * ((oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CuHR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuHI", p, t))*(mySMEFT.getSMEFTCoeffEW("YdR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", s, r)) + (3*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", r, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", r, s)) - 2*(1 + 2*(mySMEFT.getSMEFTCoeffEW("CHbox") - 0.25 * mySMEFT.getSMEFTCoeffEW("CHD")) * v2 + deltaoneoMh2)*(mySMEFT.getSMEFTCoeffEW("YdR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", s, r)))*(mySMEFT.getSMEFTCoeffEW("YuR", t, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YuI", t, p))))/12.) * VdL(r,j) * VuR(t,l);
                                                                            CudduV8LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VdRd(k,s) * ((oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CuHR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuHI", p, t))*(mySMEFT.getSMEFTCoeffEW("YdR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", s, r)) + (3*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", r, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", r, s)) - 2*(1 + 2*(mySMEFT.getSMEFTCoeffEW("CHbox") - 0.25 * mySMEFT.getSMEFTCoeffEW("CHD")) * v2 + deltaoneoMh2)*(mySMEFT.getSMEFTCoeffEW("YdR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", s, r)))*(mySMEFT.getSMEFTCoeffEW("YuR", t, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YuI", t, p))))/2.) * VdL(r,j) * VuR(t,l);
                                                                        }
                                                                }
                                                }
                                }
                                                ...
                                                for (int r = 0; r < 3; r++)
                                                {
                                                        ...
                                                        for (int s = 0; s < 3; s++)
                                                                for (int t = 0; t < 3; t++)
                                                                {
                                                                        ...
                                                                        if (mySMEFT.FlagNewTerms) {
                                                                            CudS1RR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VdLd(k,s) * ((oneoMh2*(-3*v2*(mySMEFT.getSMEFTCoeffEW("CuHR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuHI", p, r))*(mySMEFT.getSMEFTCoeffEW("YdR", t, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", t, s)) + (-3*v2*(mySMEFT.getSMEFTCoeffEW("CdHR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CdHI", s, t)) + 2*(1 + 2*(mySMEFT.getSMEFTCoeffEW("CHbox") - 0.25 * mySMEFT.getSMEFTCoeffEW("CHD")) * v2 + deltaoneoMh2)*(mySMEFT.getSMEFTCoeffEW("YdR", t, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YdI", t, s)))*(mySMEFT.getSMEFTCoeffEW("YuR", r, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YuI", r, p))))/2.) * VuR(r,j) * VdR(t,l);
                                                                        }
                                                                }
                                                }
                                }
                                                ...
                                                for (int r = 0; r < 3; r++)
                                                        for (int s = 0; s < 3; s++)
                                                                for (int t = 0; t < 3; t++)
                                                                {
                                                                        ...
                                                                        CuuVLL.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuLd(k,s) * ((gZ2oMZ2*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHq1R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, t))*(mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r)) - gZ2oMZ2*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r))*(mySMEFT.getSMEFTCoeffEW("CHq3R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, t)) + gZ2oMZ2*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHq1R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, r))*(-(mySMEFT.getSMEFTCoeffEW("CHq1R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, t)) + (mySMEFT.getSMEFTCoeffEW("CHq3R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, t))))/8.) * VuL(r,j) * VuL(t,l);
                                                                        CuuVRR.at(i).at(j).at(k).at(l) += VuRd(i,p) * VuRd(k,s) * (-0.125*(gZ2oMZ2*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHuR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", p, r))*(mySMEFT.getSMEFTCoeffEW("CHuR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", s, t)))) * VuR(r,j) * VuR(t,l);
                                                                        CuuV1LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * (-0.25*(gZ2oMZ2*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHq1R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, r))*(mySMEFT.getSMEFTCoeffEW("CHuR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", s, t))) + (gZ2oMZ2*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r))*(mySMEFT.getSMEFTCoeffEW("CHuR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", s, t)))/4.) * VuL(r,j) * VuR(t,l);
                                                                        if (mySMEFT.FlagNewTerms) {
                                                                            ...
                                                                            CuuV8LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * ((oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CuHR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuHI", p, t))*(mySMEFT.getSMEFTCoeffEW("YuR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YuI", s, r)) + (3*v2*(mySMEFT.getSMEFTCoeffEW("CuHR", r, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuHI", r, s)) - 2*(1 + 2*(mySMEFT.getSMEFTCoeffEW("CHbox") - 0.25 * mySMEFT.getSMEFTCoeffEW("CHD")) * v2 + deltaoneoMh2)*(mySMEFT.getSMEFTCoeffEW("YuR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YuI", s, r)))*(mySMEFT.getSMEFTCoeffEW("YuR", t, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("YuI", t, p))))/2.) * VuL(r,j) * VuR(t,l);
                                                                            ...
                                                                            CuuVLL.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, r)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r)))*(sbar*(mySMEFT.getSMEFTCoeffEW("CuBR", t, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuBI", t, s)) + cbar*(mySMEFT.getSMEFTCoeffEW("CuWR", t, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuWI", t, s)))*Mu[k])/(4.*sqrt(2))) * VuL(r,j) * VuL(t,l);
                                                                            CuuVLL.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuLd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, r)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r)))*(sbar*(mySMEFT.getSMEFTCoeffEW("CuBR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuBI", s, t)) + cbar*(mySMEFT.getSMEFTCoeffEW("CuWR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuWI", s, t)))*Mu[l])/(4.*sqrt(2))) * VuL(r,j) * VuR(t,l);
                                                                            CuuVLL.at(i).at(j).at(k).at(l) += VuRd(i,p) * VuLd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, t)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, t)))*(sbar*(mySMEFT.getSMEFTCoeffEW("CuBR", r, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuBI", r, p)) + cbar*(mySMEFT.getSMEFTCoeffEW("CuWR", r, p) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuWI", r, p)))*Mu[i])/(4.*sqrt(2))) * VuL(r,j) * VuL(t,l);
                                                                            CuuVLL.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuLd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, t)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, t)))*(sbar*(mySMEFT.getSMEFTCoeffEW("CuBR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuBI", p, r)) + cbar*(mySMEFT.getSMEFTCoeffEW("CuWR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuWI", p, r)))*Mu[j])/(4.*sqrt(2))) * VuR(r,j) * VuL(t,l);
                                                                            CuuVRR.at(i).at(j).at(k).at(l) += VuRd(i,p) * VuRd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHuR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", p, r))*(sbar*(mySMEFT.getSMEFTCoeffEW("CuBR", t, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuBI", t, s)) + cbar*(mySMEFT.getSMEFTCoeffEW("CuWR", t, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuWI", t, s)))*Mu[l])/(4.*sqrt(2)))* VuR(r,j) * VuL(t,l);
                                                                            ...
                                                                            CuuVRR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) *((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHuR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", s, t))*(sbar*(mySMEFT.getSMEFTCoeffEW("CuBR", p ,r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuBI", p ,r)) + cbar*(mySMEFT.getSMEFTCoeffEW("CuWR", p ,r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuWI", p ,r)))*Mu[i])/(4.*sqrt(2))) * VuR(r,j) * VuR(t,l);
                                                                            CuuV1LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * (-0.041666666666666664*(oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CuHR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuHI", p, t))*(3*mySMEFT.FlagQuadraticWC*v2*(mySMEFT.getSMEFTCoeffEW("CuHR", r, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuHI", r, s)))))) * VuL(r,j) * VuR(t,l);
                                                                            ...
                                                                            CuuV1LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, r)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r)))*(sbar*(mySMEFT.getSMEFTCoeffEW("CuBR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuBI", s, t)) + cbar*(mySMEFT.getSMEFTCoeffEW("CuWR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuWI", s, t)))*Mu[k])/(2.*sqrt(2))) * VuL(r,j) * VuR(t,l);
                                                                            ...
                                                                            CuuV1LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * ((gZbar2oMZ3*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHuR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", s, t))*(sbar*(mySMEFT.getSMEFTCoeffEW("CuBR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuBI", p, r)) + cbar*(mySMEFT.getSMEFTCoeffEW("CuWR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuWI", p, r)))*Mu[j])/(2.*sqrt(2))) * VuL(r,j) * VuR(t,l);
                                                                            CuuV1LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * (-0.041666666666666664*(gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, r)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, r)))*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, t)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, t)))*Mu[k]*Mu[l])) * VuL(r,j) * VuR(t,l);
                                                                            CuuV1LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * ((gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, t)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, t)))*(mySMEFT.getSMEFTCoeffEW("CHuR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", s, r))*Mu[j]*Mu[l])/24.) * VuL(r,j) * VuR(t,l);
                                                                            CuuV1LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * ((gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, r)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, r)))*(mySMEFT.getSMEFTCoeffEW("CHuR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", p, t))*Mu[i]*Mu[k])/24.) * VuL(r,j) * VuR(t,l);
                                                                            CuuV1LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * (-0.041666666666666664*(gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHuR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", p, t))*(mySMEFT.getSMEFTCoeffEW("CHuR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", s, r))*Mu[i]*Mu[j])) * VuL(r,j) * VuR(t,l);
                                                                            CuuV8LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * (-0.25*(oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CuHR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuHI", p, t))*(3*mySMEFT.FlagQuadraticWC*v2*(mySMEFT.getSMEFTCoeffEW("CuHR", r, s) - gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuHI", r, s)))))) * VuL(r,j) * VuR(t,l);
                                                                            CuuV8LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * (-0.25*(gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, r)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, r)))*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, t)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, t)))*Mu[k]*Mu[l])) * VuL(r,j) * VuR(t,l);
                                                                            CuuV8LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * ((gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, t)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, t)))*(mySMEFT.getSMEFTCoeffEW("CHuR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", s, r))*Mu[j]*Mu[l])/4.) * VuL(r,j) * VuR(t,l);
                                                                            CuuV8LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * ((gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, r)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, r)))*(mySMEFT.getSMEFTCoeffEW("CHuR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", p, t))*Mu[i]*Mu[k])/4.) * VuL(r,j) * VuR(t,l);
                                                                            CuuV8LR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuRd(k,s) * (-0.25*(gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHuR", p, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", p, t))*(mySMEFT.getSMEFTCoeffEW("CHuR", s, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", s, r))*Mu[i]*Mu[j])) * VuL(r,j) * VuR(t,l);
                                                                            CuuS1RR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuLd(k,s) * ((oneoMh2*(3*v2*(mySMEFT.getSMEFTCoeffEW("CuHR", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuHI", p, r))*(3*mySMEFT.FlagQuadraticWC*v2*(mySMEFT.getSMEFTCoeffEW("CuHR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CuHI", s, t)))))/8.) * VuR(r,j) * VuR(t,l);
                                                                            CuuS1RR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuLd(k,s) * ((gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, r)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r)))*(mySMEFT.getSMEFTCoeffEW("CHuR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", s, t))*Mu[j]*Mu[k])/8.) * VuR(r,j) * VuR(t,l);
                                                                            CuuS1RR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuLd(k,s) * (-0.125*(gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", p, r)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", p, r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", p, r)))*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, t)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, t)))*Mu[j]*Mu[l])) * VuR(r,j) * VuR(t,l);
                                                                            CuuS1RR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuLd(k,s) * (-0.125*(gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*(mySMEFT.getSMEFTCoeffEW("CHuR", p ,r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", p ,r))*(mySMEFT.getSMEFTCoeffEW("CHuR", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", s, t))*Mu[i]*Mu[k])) * VuR(r,j) * VuR(t,l);
                                                                            CuuS1RR.at(i).at(j).at(k).at(l) += VuLd(i,p) * VuLd(k,s) * ((gZbar2oMZ4*mySMEFT.FlagQuadraticWC*v2*v2*((mySMEFT.getSMEFTCoeffEW("CHq1R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq1I", s, t)) - (mySMEFT.getSMEFTCoeffEW("CHq3R", s, t) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHq3I", s, t)))*(mySMEFT.getSMEFTCoeffEW("CHuR", p ,r) + gslpp::complex::i() * mySMEFT.getSMEFTCoeffEW("CHuI", p ,r))*Mu[i]*Mu[l])/8.) * VuR(r,j) * VuR(t,l);
                                                                        }
                                                                }
                        }
