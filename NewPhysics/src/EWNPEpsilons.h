...
public:
     ...
     * @param[in] l name of a lepton
     * @return the neutral-current vector coupling @f$g_V^l@f$ including the \f$\varepsilon_i\f$ contributions
     */
     ...
     * @param[in] q name of a quark
     * @return the neutral-current vector coupling @f$g_V^q@f$ including the \f$\varepsilon_i\f$ contributions
     */
     ...
     * @return the neutral-current axial-vector coupling @f$g_A^l@f$ including the \f$\varepsilon_i\f$ contributions
     */
     ...
     * @param[in] q name of a quark
     * @return the neutral-current axial-vector coupling @f$g_A^q@f$ including the \f$\varepsilon_i\f$ contributions
     */
