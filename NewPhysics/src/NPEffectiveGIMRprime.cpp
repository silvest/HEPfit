...
: NPbase(), FlagLeptonUniversal(FlagLeptonUniversal_in), FlagQuarkUniversal(FlagQuarkUniversal_in)
{
    ...
    if(FlagLeptonUniversal && FlagQuarkUniversal){
        ModelParamMap.insert(std::make_pair("CLQ1", std::cref(CLQ1)));
        ModelParamMap.insert(std::make_pair("CLQ3", std::cref(CLQ3)));
        ModelParamMap.insert(std::make_pair("Ceu", std::cref(Ceu)));
        ModelParamMap.insert(std::make_pair("Ced", std::cref(Ced)));
        ModelParamMap.insert(std::make_pair("CLe", std::cref(CLe)));
        ModelParamMap.insert(std::make_pair("CLu", std::cref(CLu)));
        ModelParamMap.insert(std::make_pair("CLd", std::cref(CLd)));
        ModelParamMap.insert(std::make_pair("CQe", std::cref(CQe)));
    } else {
