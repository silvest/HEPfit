...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/libgslpp.a

dist/Release/GNU-Linux-x86/libgslpp.a: ${OBJECTFILES}
	${MKDIR} -p dist/Release/GNU-Linux-x86
	${RM} dist/Release/GNU-Linux-x86/libgslpp.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libgslpp.a ${OBJECTFILES} 
	$(RANLIB) dist/Release/GNU-Linux-x86/libgslpp.a

${OBJECTDIR}/gslpp_vector_double.o: gslpp_vector_double.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/gslpp_vector_double.o gslpp_vector_double.cpp

${OBJECTDIR}/gslpp_complex.o: gslpp_complex.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/gslpp_complex.o gslpp_complex.cpp

${OBJECTDIR}/gslpp_matrix_complex.o: gslpp_matrix_complex.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/gslpp_matrix_complex.o gslpp_matrix_complex.cpp

${OBJECTDIR}/gslpp_vector_complex.o: gslpp_vector_complex.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/gslpp_vector_complex.o gslpp_vector_complex.cpp

${OBJECTDIR}/gslpp_matrix_double.o: gslpp_matrix_double.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/gslpp_matrix_double.o gslpp_matrix_double.cpp
...
${TESTDIR}/tests/gslpptest.o: tests/gslpptest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/gslpptest.o tests/gslpptest.cpp
...
${OBJECTDIR}/gslpp_vector_double_nomain.o: ${OBJECTDIR}/gslpp_vector_double.o gslpp_vector_double.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/gslpp_vector_double_nomain.o gslpp_vector_double.cpp;\
	else  \
...
${OBJECTDIR}/gslpp_complex_nomain.o: ${OBJECTDIR}/gslpp_complex.o gslpp_complex.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/gslpp_complex_nomain.o gslpp_complex.cpp;\
	else  \
...
${OBJECTDIR}/gslpp_matrix_complex_nomain.o: ${OBJECTDIR}/gslpp_matrix_complex.o gslpp_matrix_complex.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/gslpp_matrix_complex_nomain.o gslpp_matrix_complex.cpp;\
	else  \
...
${OBJECTDIR}/gslpp_vector_complex_nomain.o: ${OBJECTDIR}/gslpp_vector_complex.o gslpp_vector_complex.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/gslpp_vector_complex_nomain.o gslpp_vector_complex.cpp;\
	else  \
...
${OBJECTDIR}/gslpp_matrix_double_nomain.o: ${OBJECTDIR}/gslpp_matrix_double.o gslpp_matrix_double.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/gslpp_matrix_double_nomain.o gslpp_matrix_double.cpp;\
	else  \
