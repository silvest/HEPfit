/*
 * File:   EW3testclass.cpp
 * Author: mishima
 */

#include "EW3testclass.h"


CPPUNIT_TEST_SUITE_REGISTRATION(EW3testclass);

EW3testclass::EW3testclass() {
}

EW3testclass::~EW3testclass() {
}

void EW3testclass::setUp() {
...
void EW3testclass::tearDown() {
    delete myEW3;        
    delete myEWSMC;
    delete mySM;  
}

void EW3testclass::setSMparameters(StandardModel& SM_i) {
...
void EW3testclass::DeltaAlpha_l() {
