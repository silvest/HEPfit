...
${TESTDIR}/tests/testclass.o: tests/testclass.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. -Isrc -I../gslpp/src -I../StandardModel/src -I../LoopFunctions/src -I../gslpp/src -I../StandardModel/src -I../LoopFunctions/src -MMD -MP -MF $@.d -o ${TESTDIR}/tests/testclass.o tests/testclass.cpp


${TESTDIR}/tests/testrunner.o: tests/testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. -Isrc -I../gslpp/src -I../StandardModel/src -I../LoopFunctions/src -I../gslpp/src -I../StandardModel/src -I../LoopFunctions/src -MMD -MP -MF $@.d -o ${TESTDIR}/tests/testrunner.o tests/testrunner.cpp
