...
public:
     ...
     * @return delta rho_{rem}^{l, G^2 alpha_s}
     */
     ...
     * @return delta rho_{rem}^{q, G^2 alpha_s}
     */
     ...
     * @param[in] l name of a lepton 
     * @return delta kappa_{rem}^{l, G^2 alpha_s}
     */
     ...
     * @param[in] q name of a quark 
     * @return delta kappa_{rem}^{q, G^2 alpha_s}
     */
