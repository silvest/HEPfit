...
public:
     ...
     * @return delta rho_{rem}^{l, G alpha_s^2}
     */
     ...
     * @return delta rho_{rem}^{q, G alpha_s^2}
     */
     ...
     * @param[in] l name of a lepton 
     * @return delta kappa_{rem}^{l, G alpha_s^2}
     */
     ...
     * @param[in] q name of a quark 
     * @return delta kappa_{rem}^{q, G alpha_s^2}
     */
