...
${OBJECTDIR}/src/MonteCarloEngine.o: src/MonteCarloEngine.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I. -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/MonteCarloEngine.o src/MonteCarloEngine.cpp
...
${TESTDIR}/tests/MCtest.o: tests/MCtest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/MCtest.o tests/MCtest.cpp


${TESTDIR}/tests/newsimpletest.o: tests/newsimpletest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newsimpletest.o tests/newsimpletest.cpp
...
${OBJECTDIR}/src/MonteCarloEngine_nomain.o: ${OBJECTDIR}/src/MonteCarloEngine.o src/MonteCarloEngine.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -I. -I. -I. -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/MonteCarloEngine_nomain.o src/MonteCarloEngine.cpp;\
	else  \
