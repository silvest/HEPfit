...
/**
 * @class eeffAFBelectrontsub
 * @ingroup EW
 * @brief A class for the forward-backward asymmetry of @f$e^+e^-\to e^+e^-@f$, subtracting the SM t channel. 
 * above the @f$Z@f$ pole.
 * @author HEPfit Collaboration
 * @copyright GNU General Public License
 * @details 
 */
class eeffAFBelectrontsub : public eeffThObservable {
public:
