...
{ 
    ...
    if ( checkLEP2GIMR() ) {
        double deltaR_c = 0., dsigma_c = 0.0, dsigma_had =0.0;
        ...
        dsigma_c = myLEP2GIMR.sigma_q_LEP2_GIMR(QCD::CHARM, s, GIMRParamBOTTOM);
        
        deltaR_c = R_c*(1-dsigma_had/sigma_had)+dsigma_c/sigma_had;
